...
class RenameHpfsRequest(CTYunRequest):
    """
    并行文件重命名
    """

    def __init__(self, request_param):
        super(RenameHpfsRequest, self).__init__("/v4/hpfs/rename-sfs", "POST", "hpfs", "application/json")
...
class RenameHpfsRequestParam(object):

    def __init__(self, region_id, sfs_uid, sfs_name, ):
        """
        :param region_id: 资源池 ID	
        :param sfs_uid: 并行文件唯一ID	
        :param sfs_name: 文件系统新名称	
        """
