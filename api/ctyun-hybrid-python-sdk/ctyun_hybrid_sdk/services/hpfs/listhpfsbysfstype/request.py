...
class ListHpfsBySfstypeRequest(CTYunRequest):
    """
    查询指定存储类型的并行文件列表
    """

    def __init__(self, request_param):
        super(ListHpfsBySfstypeRequest, self).__init__("/v4/hpfs/list-sfs-by-sfstype", "GET", "hpfs", "")
...
class ListHpfsBySfstypeRequestParam(object):

    def __init__(self, region_id, sfs_type, az_name=None, project_id=None, page_size=None, page_no=None):
        """
