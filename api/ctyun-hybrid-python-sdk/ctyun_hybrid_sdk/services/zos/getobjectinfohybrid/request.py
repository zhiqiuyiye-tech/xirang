...
class GetObjectInfoHybridRequest(CTYunRequest):
    """
    1. 文件key为文件前缀+文件名称；   
    ...
    def __init__(self, request_param):
        super(GetObjectInfoHybridRequest, self).__init__("/v4/oss/get-object-info", "GET", "zos", "")
...
class GetObjectInfoHybridRequestParam(object):
