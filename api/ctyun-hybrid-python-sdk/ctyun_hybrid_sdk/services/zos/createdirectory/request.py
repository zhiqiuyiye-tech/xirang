...
class CreateDirectoryRequest(CTYunRequest):
    """
    创建文件夹
    """

    def __init__(self, request_param):
        super(CreateDirectoryRequest, self).__init__("/v4/oss/create-directory", "POST", "zos", "application/json")
...
class CreateDirectoryRequestParam(object):

    def __init__(self, region_id, bucket, key, ):
        """
        :param region_id: 区域 ID 
        :param bucket: 桶名
        :param key: 需要创建的文件夹名称
        """
