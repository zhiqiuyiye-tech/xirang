...
class ListObjectClusterPoolsRequest(CTYunRequest):
    """
    查询对象存储集群存储池列表
    """

    def __init__(self, request_param):
        super(ListObjectClusterPoolsRequest, self).__init__("/v4/object-storage/list-pool", "GET", "zos", "")
...
class ListObjectClusterPoolsRequestParam(object):

    def __init__(self, region_id, cluster_id=None, pool_id=None, pool_name=None, page_no=None, page_size=None):
        """
