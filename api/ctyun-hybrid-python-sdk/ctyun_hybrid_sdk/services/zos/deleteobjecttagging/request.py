...
class DeleteObjectTaggingRequest(CTYunRequest):
    """
    多版本场景下versionID必传，不然无法删除标签
    """

    def __init__(self, request_param):
        super(DeleteObjectTaggingRequest, self).__init__("/v4/oss/delete-object-tagging", "POST", "zos", "application/json")
...
class DeleteObjectTaggingRequestParam(object):

    def __init__(self, region_id, key, bucket, version_id=None):
        """
        :param region_id: 资源池id
        :param key: 对象名
        :param bucket: 桶名称
        :param version_id: 多版本场景下必传，指定对象的特定版本
        """
