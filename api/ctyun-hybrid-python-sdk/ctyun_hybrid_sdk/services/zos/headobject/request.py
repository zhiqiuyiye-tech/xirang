...
class HeadObjectRequest(CTYunRequest):
    """
    查询对象是否存在
    """

    def __init__(self, request_param):
        super(HeadObjectRequest, self).__init__("/v4/oss/head-object", "GET", "zos", "")
...
class HeadObjectRequestParam(object):
    ...
    def __init__(self, region_id, bucket, key, version_id=None):
        ...
        :param key: 对象名
        :param version_id: 版本ID，多版本场景下必传，指定对象的特定版本
        """
