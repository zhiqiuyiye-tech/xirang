...
class ListObjectClusterNodesRequest(CTYunRequest):
    """
    查询对象存储集群节点列表
    """

    def __init__(self, request_param):
        super(ListObjectClusterNodesRequest, self).__init__("/v4/object-storage/list-node", "GET", "zos", "")
...
class ListObjectClusterNodesRequestParam(object):
