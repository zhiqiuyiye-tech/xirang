...
class GetObjectTaggingRequest(CTYunRequest):
    """
    查询对象（Object）标签
    """

    def __init__(self, request_param):
        super(GetObjectTaggingRequest, self).__init__("/v4/oss/get-object-tagging", "GET", "zos", "")
...
class GetObjectTaggingRequestParam(object):
