...
class V4PaasElbDeleteLoadbalancerRequest(CTYunRequest):
    """
    本接口用于删除负载均衡实例：   
    ...
    def __init__(self, request_param):
        super(V4PaasElbDeleteLoadbalancerRequest, self).__init__("/v4/paas/elb/delete-loadbalancer", "POST", "ct", "application/json")
...
class V4PaasElbDeleteLoadbalancerRequestParam(object):

    def __init__(self, id, region_id, client_token, channel_info=None):
        """
        :param id: 负载均衡id
