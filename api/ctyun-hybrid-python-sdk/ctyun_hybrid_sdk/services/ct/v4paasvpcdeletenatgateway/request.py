...
class V4PaasVpcDeleteNatGatewayRequest(CTYunRequest):
    """
    本接口用于删除NAT网关：   
    ...
    def __init__(self, request_param):
        super(V4PaasVpcDeleteNatGatewayRequest, self).__init__("/v4/paas/vpc/delete-nat-gateway", "POST", "ct", "application/json")
...
class V4PaasVpcDeleteNatGatewayRequestParam(object):

    def __init__(self, region_id, nat_gateway_id, channel_info=None, client_token=None):
        """
