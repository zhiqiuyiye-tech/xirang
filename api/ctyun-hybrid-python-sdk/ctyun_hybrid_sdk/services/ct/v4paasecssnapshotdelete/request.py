...
class V4PaasEcsSnapshotDeleteRequest(CTYunRequest):
    """
    本接口用于删除云主机快照 查询接口为/v4/job/info
    """

    def __init__(self, request_param):
        super(V4PaasEcsSnapshotDeleteRequest, self).__init__("/v4/paas/ecs/snapshot-delete", "POST", "ct", "application/json")
...
class ChannelInfo(object):
    ...
    def __init__(self, paas_resource_id, paas_account_id, master_order_id, tags=None, metas=None):
        ...
        :param tags: 自定义map结构（公有云和v2没有）
        :param metas: 自定义map结构（公有云和v2没有）
        """
...
class V4PaasEcsSnapshotDeleteRequestParam(object):

    def __init__(self, channel_info, client_token, region_id, snapshot_id, ):
        """
