...
class V4PaasEbsResizeEbsRequest(CTYunRequest):
    """
    变更云硬盘配置(工单)
    """

    def __init__(self, request_param):
        super(V4PaasEbsResizeEbsRequest, self).__init__("/v4/paas/ebs/resize-ebs", "POST", "ct", "application/json")
...
class V4PaasEbsResizeEbsRequestParam(object):

    def __init__(self, client_token, disk_id, disk_size, channel_info=None, region_id=None):
        """
        :param channel_info: 渠道侧信息
        :param client_token: 客户端存根，用于保证订单幂等性。要求单个云平台账户内唯一
        :param region_id: 资源池ID，如本地语境支持保存regionID，那么建议传递
        :param disk_id: 磁盘ID
        :param disk_size: 变配后的磁盘大小。当前仅支持变更磁盘大小,单位为GB 10-32768
        """
