...
class AssignIPv6ToPortRequest(CTYunRequest):
    ...
    def __init__(self, request_param):
        super(AssignIPv6ToPortRequest, self).__init__("/v4/ecs/ports/assign-ipv6", "POST", "ctecs", "application/json")
...
class AssignIPv6ToPortRequestParam(object):
    ...
    def __init__(self, region_id, network_interface_id, client_token, ipv6_addresses_count=None, ipv6_addresses=None):
        ...
        :param ipv6_addresses_count: 要分配的ipv6地址数量,建议不超过10个（注：ipv6_address_count和ipv6_addresses必传一个，且不能同时指定）
        :param ipv6_addresses: 要分配的IPV6地址,建议不超过10个 注意:此参数为数组
    ...
    def set_ipv6_addresses(self, ipv6_addresses):
        """
        :param ipv6_addresses: 要分配的IPV6地址,建议不超过10个
        """
        self.ipv6_addresses = ipv6_addresses
