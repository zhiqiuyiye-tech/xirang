...
class EcsAffinityGroupListRequest(CTYunRequest):
    """
    查询云主机组列表或者详情
    """

    def __init__(self, request_param):
        super(EcsAffinityGroupListRequest, self).__init__("/v4/ecs/affinity-group-list", "POST", "ctecs", "application/json")
...
class EcsAffinityGroupListRequestParam(object):

    def __init__(self, region_id, page_no=None, page_size=None, az_name=None, affinity_group_id=None, query_content=None, asc=None, sort=None):
        """
