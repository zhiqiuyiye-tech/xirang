...
class QueryResizeFlavorRequest(CTYunRequest):
    """
    判断一台云主机是否可以通过指定规格进行变配
    """

    def __init__(self, request_param):
        super(QueryResizeFlavorRequest, self).__init__("/v4/ecs/query-resize-flavor", "POST", "ctecs", "application/json")
...
class QueryResizeFlavorRequestParam(object):
