...
class SnapshotPolicyDisableRequest(CTYunRequest):
    """
    停用云主机快照策略
    """

    def __init__(self, request_param):
        super(SnapshotPolicyDisableRequest, self).__init__("/v4/ecs/snapshot-policy/disable", "POST", "ctecs", "application/json")
...
class SnapshotPolicyDisableRequestParam(object):
