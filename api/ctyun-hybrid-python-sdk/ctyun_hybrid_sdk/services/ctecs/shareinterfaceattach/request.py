...
class ShareInterfaceAttachRequest(CTYunRequest):
    """
    给云主机添加共享网卡
    """

    def __init__(self, request_param):
        super(ShareInterfaceAttachRequest, self).__init__("/v4/ecs/share-interface/attach", "POST", "ctecs", "application/json")
...
class ShareInterfaceAttachRequestParam(object):

    def __init__(self, region_id, instance_id, subnet_id, ):
        """
