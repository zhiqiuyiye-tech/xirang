...
class VmNetworkLatestMetricDataRequest(CTYunRequest):
    """
    注：该接口不推荐使用。建议使用-->实时监控数据：云主机(/v4.1/monitor/query-vm-latestmetricdata)
    """

    def __init__(self, request_param):
        super(VmNetworkLatestMetricDataRequest, self).__init__("/v4/ecs/vm-network-latest-metric-data", "POST", "ctecs", "application/json")
...
class VmNetworkLatestMetricDataRequestParam(object):
