...
class AffinityGroupListVdcRequest(CTYunRequest):
    """
    查询云主机组列表或者详情，该接口1.16.06及以上云管版本支持。
    """

    def __init__(self, request_param):
        super(AffinityGroupListVdcRequest, self).__init__("/v4/ecs/affinity-group/list-vdc", "POST", "ctecs", "application/json")
...
class AffinityGroupListVdcRequestParam(object):

    def __init__(self, region_id, page_no=None, page_size=None, affinity_group_id=None, query_content=None, asc=None, sort=None, org_id=None):
        """
        ...
        :param sort: 排序关键字，"createAt"或 “updateAt“ 等
        :param org_id: 组织id
        """
