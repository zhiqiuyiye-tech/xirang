...
class GetInsBackupListByVdcRequest(CTYunRequest):
    """
    查询云主机备份列表   
    ...
    def __init__(self, request_param):
        super(GetInsBackupListByVdcRequest, self).__init__("/v4/ecs/backup/list-vdc", "POST", "ctecs", "application/json")
...
class GetInsBackupListByVdcRequestParam(object):

    def __init__(self, region_id, page_no=None, page_size=None, instance_id=None, repository_id=None, instance_backup_id=None, query_content=None, instance_backup_status=None, org_id=None):
        """
        ...
        :param query_content: 查询内容：（匹配：云主机备份名称、云主机备份ID、云主机名称）
