...
class ListInstanceSfsV41Request(CTYunRequest):
    """
    可以根据虚机查询绑定的文件系统列表(仅4.0支持)
    """

    def __init__(self, request_param):
        super(ListInstanceSfsV41Request, self).__init__("/v4/ecs/sfs/list", "GET", "ctecs", "")
...
class ListInstanceSfsV41RequestParam(object):
