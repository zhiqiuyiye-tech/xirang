...
class InstanceDetailsV41Request(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(InstanceDetailsV41Request, self).__init__("/v4.1/ecs/instance-details", "GET", "ctecs", "")
...
class InstanceDetailsV41RequestParam(object):
