...
class BackupPolicyListInstancesRequest(CTYunRequest):
    """
    查询云主机备份策略绑定云主机信息
    """

    def __init__(self, request_param):
        super(BackupPolicyListInstancesRequest, self).__init__("/v4/ecs/backup-policy/list-instances", "GET", "ctecs", "")
...
class BackupPolicyListInstancesRequestParam(object):

    def __init__(self, region_id, policy_id, instance_name=None, page_no=None, page_size=None):
        """
        :param region_id: 资源池ID
        :param policy_id: 云主机备份策略ID
