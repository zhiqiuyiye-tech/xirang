...
class EcsAffinityGroupBindOneRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(EcsAffinityGroupBindOneRequest, self).__init__("/v4/ecs/affinity-group/bind-one", "POST", "ctecs", "application/json")
...
class EcsAffinityGroupBindOneRequestParam(object):
