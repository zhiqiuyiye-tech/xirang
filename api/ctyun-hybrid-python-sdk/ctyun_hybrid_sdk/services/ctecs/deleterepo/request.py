...
class DeleteRepoRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(DeleteRepoRequest, self).__init__("/v4/ecs/backup-repo/delete", "POST", "ctecs", "application/json")
...
class DeleteRepoRequestParam(object):

    def __init__(self, client_token, region_id, repository_id, ):
        """
