...
class VmNetworkHistoryMetricDataRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(VmNetworkHistoryMetricDataRequest, self).__init__("/v4/ecs/vm-network-history-metric-data", "POST", "ctecs", "application/json")
...
class VmNetworkHistoryMetricDataRequestParam(object):
