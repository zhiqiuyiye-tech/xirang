...
class SnapshotPolicyDetailsRequest(CTYunRequest):
    """
    查询云主机快照策略详情
    """

    def __init__(self, request_param):
        super(SnapshotPolicyDetailsRequest, self).__init__("/v4/ecs/snapshot-policy/details", "POST", "ctecs", "application/json")
...
class SnapshotPolicyDetailsRequestParam(object):
