...
class EcsAffinityGroupUnbindOneRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(EcsAffinityGroupUnbindOneRequest, self).__init__("/v4/ecs/affinity-group/unbind-one", "POST", "ctecs", "application/json")
...
class EcsAffinityGroupUnbindOneRequestParam(object):
