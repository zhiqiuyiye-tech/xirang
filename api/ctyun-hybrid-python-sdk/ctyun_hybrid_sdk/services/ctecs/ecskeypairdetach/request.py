...
class EcsKeypairDetachRequest(CTYunRequest):
    """
    为Linux云主机解绑SSH密钥对   
    ...
    def __init__(self, request_param):
        super(EcsKeypairDetachRequest, self).__init__("/v4/ecs/keypair/detach", "POST", "ctecs", "application/json")
...
class EcsKeypairDetachRequestParam(object):

    def __init__(self, region_id, id, key_pair_name=None):
        """
