...
class SnapshotListRequest(CTYunRequest):
    """
    查询云主机快照列表
    """

    def __init__(self, request_param):
        super(SnapshotListRequest, self).__init__("/v4/ecs/snapshot/list", "POST", "ctecs", "application/json")
...
class SnapshotListRequestParam(object):

    def __init__(self, region_id, project_id=None, page_no=None, page_size=None, instance_id=None, snapshot_status=None, snapshot_id=None, query_content=None, snapshot_name=None):
        """
        :param region_id: 区域ID
        :param project_id: 企业项目ID 公有云字段，混合云暂不匹配
        :param page_no: 页码，默认值:1
        :param page_size: 每页记录数目，取值范围：[1, 100]，超过100按100处理
        :param instance_id: 云主机实例ID
        :param snapshot_status: 快照状态  公有云字段，混合云暂不支持，忽略
        :param snapshot_id: 云主机快照实例ID
        :param query_content: 模糊查找，根据快照名称、快照id、创建快照的云主机名称或创建快照的云主机id是否包含或等于该参数值进行筛选(instanceID、snapshotID、snapshotName)
