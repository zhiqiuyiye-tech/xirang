...
class BackupDetailsRequest(CTYunRequest):
    """
    查询云主机备份详情
    """

    def __init__(self, request_param):
        super(BackupDetailsRequest, self).__init__("/v4/ecs/backup/details", "GET", "ctecs", "")
    ...
    def get_query_param(self):
        ...
        if self.parameters.instance_backup_id is not None:
            query_param["instanceBackupID"] = self.parameters.instance_backup_id
        return query_param
...
class BackupDetailsRequestParam(object):
