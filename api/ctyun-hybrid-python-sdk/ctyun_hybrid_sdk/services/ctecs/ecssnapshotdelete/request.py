...
class EcsSnapshotDeleteRequest(CTYunRequest):
    """
    删除云主机快照
    """

    def __init__(self, request_param):
        super(EcsSnapshotDeleteRequest, self).__init__("/v4/ecs/snapshot-delete", "POST", "ctecs", "application/json")
...
class EcsSnapshotDeleteRequestParam(object):
