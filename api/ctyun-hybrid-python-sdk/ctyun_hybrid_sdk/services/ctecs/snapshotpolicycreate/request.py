...
class SnapshotPolicyCreateRequest(CTYunRequest):
    """
    创建云主机快照策略
    """

    def __init__(self, request_param):
        super(SnapshotPolicyCreateRequest, self).__init__("/v4/ecs/snapshot-policy/create", "POST", "ctecs", "application/json")
...
class SnapshotPolicyCreateRequestParam(object):

    def __init__(self, region_id, snapshot_policy_name, cycle_type, retention_type, snapshot_time=None, cycle_day=None, cycle_week=None, retention_day=None, retention_num=None, snapshot_policy_status=None):
        """
        ...
        :param snapshot_policy_status: 类型：int16;快照策略状态，是否启用，取值范围：0（不启用），<br />1（启用）<br />注：默认值1（启用）
        """
