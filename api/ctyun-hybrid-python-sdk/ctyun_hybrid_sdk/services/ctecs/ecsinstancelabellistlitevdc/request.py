...
class EcsInstanceLabelListLiteVDCRequest(CTYunRequest):
    """
    云主机轻量信息列表(带标签)
    """

    def __init__(self, request_param):
        super(EcsInstanceLabelListLiteVDCRequest, self).__init__("/v4/ecs/instance-label-list-lite-vdc", "GET", "ctecs", "")
...
class EcsInstanceLabelListLiteVDCRequestParam(object):
    ...
    def __init__(self, region_id, org_id=None, instance_id=None, page_size=None, page_no=None, keyword=None, az_name=None):
        ...
        :param keyword: 模糊搜索参数，目前支持按name、displayName、ID、privateIP
        :param az_name: 可用区
        """
