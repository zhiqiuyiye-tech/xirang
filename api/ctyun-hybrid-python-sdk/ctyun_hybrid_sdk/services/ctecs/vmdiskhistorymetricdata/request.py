...
class VmDiskHistoryMetricDataRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(VmDiskHistoryMetricDataRequest, self).__init__("/v4/ecs/vm-disk-history-metric-data", "POST", "ctecs", "application/json")
...
class VmDiskHistoryMetricDataRequestParam(object):
