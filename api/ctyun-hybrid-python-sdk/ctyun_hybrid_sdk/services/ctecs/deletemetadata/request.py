...
class DeleteMetadataRequest(CTYunRequest):
    """
    仅4.0支持，删除云主机元数据，云主机需为运行中或者关机状态
    """

    def __init__(self, request_param):
        super(DeleteMetadataRequest, self).__init__("/v4/ecs/metadata/delete", "POST", "ctecs", "application/json")
...
class DeleteMetadataRequestParam(object):
