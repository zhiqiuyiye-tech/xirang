...
class KeypairDetailsRequest(CTYunRequest):
    """
    此接口提供用户查询SSH密钥对功能。系统会接收用户输入的查询条件，并返回符合条件的密钥对详细信息。用户可根据此接口的返回值了解对应条件下的密钥对信息。
    """

    def __init__(self, request_param):
        super(KeypairDetailsRequest, self).__init__("/v4/ecs/keypair/details", "POST", "ctecs", "application/json")
...
class KeypairDetailsRequestParam(object):

    def __init__(self, region_id, page_no=None, page_size=None, key_pair_name=None, query_content=None, project_id=None):
        """
        :param region_id: 资源池id
        :param page_no: 页码，默认值:1
        :param page_size: 最大100
        :param key_pair_name: 密钥对名称
        :param query_content: 模糊匹配查询内容（匹配字段：keyPairName、keyPairID）
    ...
    def set_key_pair_name(self, key_pair_name):
        """
        :param key_pair_name: 密钥对名称
        """
        self.key_pair_name = key_pair_name
