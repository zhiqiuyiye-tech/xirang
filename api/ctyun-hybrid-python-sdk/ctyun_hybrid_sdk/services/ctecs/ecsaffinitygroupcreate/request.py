...
class EcsAffinityGroupCreateRequest(CTYunRequest):
    """
    创建云主机组
    """

    def __init__(self, request_param):
        super(EcsAffinityGroupCreateRequest, self).__init__("/v4/ecs/affinity-group-create", "POST", "ctecs", "application/json")
...
class EcsAffinityGroupCreateRequestParam(object):

    def __init__(self, region_id, affinity_group_name, policy_id, az_name=None, project_id=None):
        """
        :param region_id: 资源池ID
        :param az_name: 可用区名称
        :param affinity_group_name: 主机亲和组名称,长度为1-64字符 支持使用中文、英文字母、数字、下划线(_)、中划线(-)、点号(.)，不可重复
        :param policy_id: 主机亲和组策略ID，如：0(反亲和ANTI-AFFINITY)、1(亲和AFFINITY)、2(软反亲和SOFT-ANTI-AFFINITY)、3(软亲和SOFT-AFFINITY)
