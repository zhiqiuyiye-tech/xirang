...
class CreateCommandRequest(CTYunRequest):
    """
    调用此接口可以创建一条云助手命令
    """

    def __init__(self, request_param):
        super(CreateCommandRequest, self).__init__("/v4/cloud-assistant/create-command", "POST", "ctecs", "application/json")
...
class CreateCommandRequestParam(object):

    def __init__(self, region_id, command_name, command_type, command_content, project_id=None, description=None, working_directory=None, timeout=None, enabled_parameter=None, default_parameter=None):
        """
        :param region_id: 资源池ID
        :param project_id: 混合云企业项目ID
        ...
        :param working_directory: 命令在实例中运行目录。Linux系统默认路径为 /tmp;Windows系统默认路径为C:/Windows/System32 说明：若在Windows系统云主机下执行Python脚本命令，需传Python安装全路径。最长128字符，仅支持中文、大小写字母、数字、横线(-)、下划线(_)、小数点(.)、英文冒号(:)、斜杠(/)和反斜杠(\\\\) （需转义后）。
