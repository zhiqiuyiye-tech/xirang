...
class InstanceDetailsRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(InstanceDetailsRequest, self).__init__("/v4/ecs/instance-details", "GET", "ctecs", "")
...
class InstanceDetailsRequestParam(object):
