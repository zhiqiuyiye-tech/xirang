...
class EcsDeleteDelegateRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(EcsDeleteDelegateRequest, self).__init__("/v4/ecs/delegate/delete", "POST", "ctecs", "application/json")
...
class EcsDeleteDelegateRequestParam(object):
