...
class VmDiskLatestMetricDataRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(VmDiskLatestMetricDataRequest, self).__init__("/v4/ecs/vm-disk-latest-metric-data", "POST", "ctecs", "application/json")
...
class VmDiskLatestMetricDataRequestParam(object):
