...
class ResumeInstanceRequest(CTYunRequest):
    """
    该接口提供用户恢复一台云主机功能。   
    ...
    def __init__(self, request_param):
        super(ResumeInstanceRequest, self).__init__("/v4/ecs/resume", "POST", "ctecs", "application/json")
...
class ResumeInstanceRequestParam(object):
