...
class SnapshotPolicyInstanceListRequest(CTYunRequest):
    """
    查询快照策略绑定云主机列表
    """

    def __init__(self, request_param):
        super(SnapshotPolicyInstanceListRequest, self).__init__("/v4/ecs/snapshot-policy/instance-list", "POST", "ctecs", "application/json")
...
class SnapshotPolicyInstanceListRequestParam(object):
