...
class VmMemHistoryMetricDataRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(VmMemHistoryMetricDataRequest, self).__init__("/v4/ecs/vm-mem-history-metric-data", "POST", "ctecs", "application/json")
...
class VmMemHistoryMetricDataRequestParam(object):
