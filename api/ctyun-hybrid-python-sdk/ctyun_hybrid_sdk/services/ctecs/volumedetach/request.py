...
class VolumeDetachRequest(CTYunRequest):
    """
    云主机卸载云硬盘
    """

    def __init__(self, request_param):
        super(VolumeDetachRequest, self).__init__("/v4/ecs/volume/detach", "POST", "ctecs", "application/json")
...
class VolumeDetachRequestParam(object):

    def __init__(self, region_id, disk_id, instance_id, ):
        """
