...
class StartInstanceRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(StartInstanceRequest, self).__init__("/v4/ecs/start-instance", "POST", "ctecs", "application/json")
...
class StartInstanceRequestParam(object):
