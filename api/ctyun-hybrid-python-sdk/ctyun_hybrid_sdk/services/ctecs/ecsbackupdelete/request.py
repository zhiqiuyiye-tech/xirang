...
class EcsBackupDeleteRequest(CTYunRequest):
    """
    删除云主机备份
    """

    def __init__(self, request_param):
        super(EcsBackupDeleteRequest, self).__init__("/v4/ecs/backup-delete", "POST", "ctecs", "application/json")
...
class EcsBackupDeleteRequestParam(object):
