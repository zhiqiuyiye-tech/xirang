...
class EcsBackupStatusRequest(CTYunRequest):
    """
    查询云主机备份状态
    """

    def __init__(self, request_param):
        super(EcsBackupStatusRequest, self).__init__("/v4/ecs/backup-status", "POST", "ctecs", "application/json")
...
class EcsBackupStatusRequestParam(object):
