...
class ListBackupPolicyRequest(CTYunRequest):
    """
    查询云主机备份策略列表
    """

    def __init__(self, request_param):
        super(ListBackupPolicyRequest, self).__init__("/v4/ecs/backup-policy/list", "GET", "ctecs", "")
...
class ListBackupPolicyRequestParam(object):

    def __init__(self, region_id, policy_id=None, policy_name=None, page_no=None, page_size=None, project_id=None):
        """
        :param region_id: 资源池id
        :param policy_id: 备份策略ID
        :param policy_name: 备份策略名，指定了policyID时，该参数会被忽略
