...
class BatchRebootInstancesRequest(CTYunRequest):
    """
    批量重启云主机(1.15)   
    ...
    def __init__(self, request_param):
        super(BatchRebootInstancesRequest, self).__init__("/v4/ecs/batch-reboot-instances", "POST", "ctecs", "application/json")
...
class BatchRebootInstancesRequestParam(object):

    def __init__(self, region_id, instance_id_list, ):
        """
        :param region_id: 资源池ID
        :param instance_id_list: 云主机ID列表，字符串，英文逗号分割
        """
