...
class RenewRepoRequest(CTYunRequest):
    ...
    def __init__(self, request_param):
        super(RenewRepoRequest, self).__init__("/v4/ecs/backup-repo/renew", "POST", "ctecs", "application/json")
...
class RenewRepoRequestParam(object):
    ...
    def __init__(self, client_token, region_id, repository_id, cycle_type, cycle_count, ):
        """
