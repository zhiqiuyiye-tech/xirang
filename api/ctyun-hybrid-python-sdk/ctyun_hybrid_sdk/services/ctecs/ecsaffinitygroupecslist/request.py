...
class EcsAffinityGroupEcsListRequest(CTYunRequest):
    """
    可以根据用户给定的云主机组，查询云主机组内云主机的详细信息
    """

    def __init__(self, request_param):
        super(EcsAffinityGroupEcsListRequest, self).__init__("/v4/ecs/affinity-group/ecs-list", "POST", "ctecs", "application/json")
...
class EcsAffinityGroupEcsListRequestParam(object):
