...
class KeypairAttachInstanceRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(KeypairAttachInstanceRequest, self).__init__("/v4/ecs/keypair/attach-instance", "POST", "ctecs", "application/json")
...
class KeypairAttachInstanceRequestParam(object):

    def __init__(self, region_id, key_pair_name, instance_id, ):
        """
