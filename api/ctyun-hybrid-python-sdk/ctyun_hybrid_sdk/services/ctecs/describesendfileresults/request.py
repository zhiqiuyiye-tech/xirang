...
class DescribeSendFileResultsRequest(CTYunRequest):
    """
    调用此接口可以查询上传到弹性云主机或物理机的文件的结果
    """

    def __init__(self, request_param):
        super(DescribeSendFileResultsRequest, self).__init__("/v4/cloud-assistant/describe-send-file-results", "POST", "ctecs", "application/json")
...
class DescribeSendFileResultsRequestParam(object):

    def __init__(self, region_id, invoked_id=None, page_no=None, page_size=None, file_name=None):
        """
