...
class OpenapiEcsPaasDetailsV4Request(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(OpenapiEcsPaasDetailsV4Request, self).__init__("/v4/ecs/paas-details", "POST", "ctecs", "application/json")
    ...
    def get_body_param(self):
        ...
        if self.parameters.use_channel is not None:
            body_param["useChannel"] = self.parameters.use_channel
        return body_param
...
class OpenapiEcsPaasDetailsV4RequestParam(object):

    def __init__(self, region_id, az_name=None, project_id=None, page_no=None, page_size=None, status=None, keyword=None, instance_id_list=None, name=None, id=None, vpc_id=None, sg_uuid=None, use_channel=None):
        """
        ...
        :param vpc_id: 虚拟网络ID
        :param sg_uuid: 安全组ID 
        :param use_channel: 是否使用渠道过滤，默认为false，不使用渠道过滤。-不支持
        """
    ...
    def set_use_channel(self, use_channel):
        """
        :param use_channel: 是否使用渠道过滤，默认为false，不使用渠道过滤。-不支持
        """
        self.use_channel = use_channel
