...
class DeleteEipRequest(CTYunRequest):
    ...
    def __init__(self, request_param):
        super(DeleteEipRequest, self).__init__("/v4/ecs/eip/delete", "POST", "ctecs", "application/json")
...
class DeleteEipRequestParam(object):
    ...
    def __init__(self, region_id, client_token=None, resource_id=None, project_id=None, eip_id=None):
        """
