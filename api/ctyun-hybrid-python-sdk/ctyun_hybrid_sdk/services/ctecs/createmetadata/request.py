...
class CreateMetadataRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(CreateMetadataRequest, self).__init__("/v4/ecs/metadata/create", "POST", "ctecs", "application/json")
...
class CreateMetadataRequestParam(object):

    def __init__(self, region_id, metadata, instance_id, ):
        """
