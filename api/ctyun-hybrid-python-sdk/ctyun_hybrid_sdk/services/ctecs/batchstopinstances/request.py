...
class BatchStopInstancesRequest(CTYunRequest):
    """
    批量关机云主机(1.15)   
    ...
    def __init__(self, request_param):
        super(BatchStopInstancesRequest, self).__init__("/v4/ecs/batch-stop-instances", "POST", "ctecs", "application/json")
...
class BatchStopInstancesRequestParam(object):
