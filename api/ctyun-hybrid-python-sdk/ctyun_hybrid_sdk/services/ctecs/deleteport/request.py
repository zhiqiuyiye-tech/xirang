...
class DeletePortRequest(CTYunRequest):
    """
    删除弹性网卡
    """

    def __init__(self, request_param):
        super(DeletePortRequest, self).__init__("/v4/ecs/ports/delete", "POST", "ctecs", "application/json")
...
class DeletePortRequestParam(object):
