...
class EcsMetadataCreateRequest(CTYunRequest):
    """
    仅4.0支持，为云主机创建元数据，云主机需为运行中或者关机状态
    """

    def __init__(self, request_param):
        super(EcsMetadataCreateRequest, self).__init__("/v4/ecs/metadata-create", "POST", "ctecs", "application/json")
...
class EcsMetadataCreateRequestParam(object):

    def __init__(self, region_id, metadata, id, ):
        """
        :param region_id: 资源池 ID
        :param metadata: 元数据信息 字符串map，放置key-value
        :param id: 云主机ID
        """
