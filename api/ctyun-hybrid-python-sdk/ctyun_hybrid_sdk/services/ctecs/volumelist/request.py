...
class VolumeListRequest(CTYunRequest):
    """
    查询云主机的云硬盘列表。请求asc，sort 字段不支持，返回字段diskMode未对齐，isEncrypt字段不支持
    """

    def __init__(self, request_param):
        super(VolumeListRequest, self).__init__("/v4/ecs/volume/list", "POST", "ctecs", "application/json")
...
class VolumeListRequestParam(object):

    def __init__(self, region_id, instance_id, page_no=None, page_size=None, asc=None, sort=None):
        """
        ...
        :param sort: 排序关键字,目前只支持"diskSize"排序
        """
