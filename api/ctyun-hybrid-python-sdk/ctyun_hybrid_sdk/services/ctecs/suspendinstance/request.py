...
class SuspendInstanceRequest(CTYunRequest):
    """
    该接口提供用户挂起一台云主机功能。   
    ...
    def __init__(self, request_param):
        super(SuspendInstanceRequest, self).__init__("/v4/ecs/suspend", "POST", "ctecs", "application/json")
...
class SuspendInstanceRequestParam(object):
