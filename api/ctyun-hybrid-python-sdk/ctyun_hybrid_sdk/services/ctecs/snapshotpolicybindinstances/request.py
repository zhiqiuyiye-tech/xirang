...
class SnapshotPolicyBindInstancesRequest(CTYunRequest):
    """
    快照策略绑定云主机
    """

    def __init__(self, request_param):
        super(SnapshotPolicyBindInstancesRequest, self).__init__("/v4/ecs/snapshot-policy/bind-instances", "POST", "ctecs", "application/json")
...
class SnapshotPolicyBindInstancesRequestParam(object):
