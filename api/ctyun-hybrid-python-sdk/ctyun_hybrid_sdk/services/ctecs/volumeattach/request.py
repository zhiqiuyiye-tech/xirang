...
class VolumeAttachRequest(CTYunRequest):
    """
    云主机挂载云硬盘
    """

    def __init__(self, request_param):
        super(VolumeAttachRequest, self).__init__("/v4/ecs/volume/attach", "POST", "ctecs", "application/json")
...
class VolumeAttachRequestParam(object):

    def __init__(self, region_id, disk_id, instance_id, disk_bus=None):
        """
