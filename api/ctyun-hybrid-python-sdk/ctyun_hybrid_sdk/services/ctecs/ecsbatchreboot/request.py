...
class EcsBatchRebootRequest(CTYunRequest):
    """
    批量重启云主机
    """

    def __init__(self, request_param):
        super(EcsBatchRebootRequest, self).__init__("/v4/ecs/batch-reboot", "POST", "ctecs", "application/json")
...
class EcsBatchRebootRequestParam(object):

    def __init__(self, region_id, instance_id_list, az_name=None):
        """
        :param region_id: 资源池ID
        :param az_name: 可用区-暂未提供 可不传
