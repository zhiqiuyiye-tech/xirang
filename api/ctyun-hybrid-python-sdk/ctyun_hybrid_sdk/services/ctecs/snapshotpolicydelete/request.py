...
class SnapshotPolicyDeleteRequest(CTYunRequest):
    """
    删除云主机快照策略
    """

    def __init__(self, request_param):
        super(SnapshotPolicyDeleteRequest, self).__init__("/v4/ecs/snapshot-policy/delete", "POST", "ctecs", "application/json")
...
class SnapshotPolicyDeleteRequestParam(object):
