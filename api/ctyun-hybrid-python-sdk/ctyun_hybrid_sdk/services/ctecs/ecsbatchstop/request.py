...
class EcsBatchStopRequest(CTYunRequest):
    """
    停止一台或多台实例
    """

    def __init__(self, request_param):
        super(EcsBatchStopRequest, self).__init__("/v4/ecs/batch-stop", "POST", "ctecs", "application/json")
...
class EcsBatchStopRequestParam(object):
