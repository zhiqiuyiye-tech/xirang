...
class EcsBackupUsageRequest(CTYunRequest):
    """
    查看云主机备份空间占用大小
    """

    def __init__(self, request_param):
        super(EcsBackupUsageRequest, self).__init__("/v4/ecs/backup-usage", "POST", "ctecs", "application/json")
...
class EcsBackupUsageRequestParam(object):
