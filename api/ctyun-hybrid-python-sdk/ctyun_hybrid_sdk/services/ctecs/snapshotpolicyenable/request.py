...
class SnapshotPolicyEnableRequest(CTYunRequest):
    """
    启用云主机快照策略
    """

    def __init__(self, request_param):
        super(SnapshotPolicyEnableRequest, self).__init__("/v4/ecs/snapshot-policy/enable", "POST", "ctecs", "application/json")
...
class SnapshotPolicyEnableRequestParam(object):
