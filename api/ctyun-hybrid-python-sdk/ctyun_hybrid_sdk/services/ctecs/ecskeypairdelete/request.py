...
class EcsKeypairDeleteRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(EcsKeypairDeleteRequest, self).__init__("/v4/ecs/keypair/delete", "POST", "ctecs", "application/json")
...
class EcsKeypairDeleteRequestParam(object):

    def __init__(self, region_id, key_pair_name, ):
        """
