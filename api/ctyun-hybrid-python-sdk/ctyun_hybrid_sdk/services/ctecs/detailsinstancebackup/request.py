...
class DetailsInstanceBackupRequest(CTYunRequest):
    """
    查询云主机备份详情
    """

    def __init__(self, request_param):
        super(DetailsInstanceBackupRequest, self).__init__("/v4/ecs/backup-details", "POST", "ctecs", "application/json")
...
class DetailsInstanceBackupRequestParam(object):
