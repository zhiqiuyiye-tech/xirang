...
class RebootInstanceRequest(CTYunRequest):
    """
    该接口提供用户重启一台云主机功能。   
    ...
    def __init__(self, request_param):
        super(RebootInstanceRequest, self).__init__("/v4/ecs/reboot-instance", "POST", "ctecs", "application/json")
...
class RebootInstanceRequestParam(object):
