...
class EcsSnapshotStatusRequest(CTYunRequest):
    """
    查询云主机快照状态   
    ...
    def __init__(self, request_param):
        super(EcsSnapshotStatusRequest, self).__init__("/v4/ecs/snapshot-status", "POST", "ctecs", "application/json")
...
class EcsSnapshotStatusRequestParam(object):
