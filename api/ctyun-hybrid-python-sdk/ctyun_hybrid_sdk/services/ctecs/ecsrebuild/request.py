...
class EcsRebuildRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(EcsRebuildRequest, self).__init__("/v4/ecs/rebuild", "POST", "ctecs", "application/json")
...
class EcsRebuildRequestParam(object):

    def __init__(self, region_id, id, image_id, password, az_name=None, user_data=None, client_token=None):
        """
