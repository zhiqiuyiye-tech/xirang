...
class DeleteCommandRequest(CTYunRequest):
    """
    调用此接口可删除用户自己创建的云助手命令
    """

    def __init__(self, request_param):
        super(DeleteCommandRequest, self).__init__("/v4/cloud-assistant/delete-command", "POST", "ctecs", "application/json")
...
class DeleteCommandRequestParam(object):
