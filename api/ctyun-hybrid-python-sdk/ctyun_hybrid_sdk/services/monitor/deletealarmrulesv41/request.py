...
class DeleteAlarmRulesV41Request(CTYunRequest):
    """
    调用此接口可批量删除多个创建告警规则
    """

    def __init__(self, request_param):
        super(DeleteAlarmRulesV41Request, self).__init__("/v4.1/monitor/delete-alarm-rules", "POST", "monitor", "application/json")
...
class DeleteAlarmRulesV41RequestParam(object):
