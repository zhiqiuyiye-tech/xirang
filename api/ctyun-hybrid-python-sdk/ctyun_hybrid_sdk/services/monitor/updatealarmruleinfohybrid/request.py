...
class UpdateAlarmRuleInfoHybridRequest(CTYunRequest):
    """
    调用此接口可修改指定告警规则基本信息，支持全量字段修改。
    """

    def __init__(self, request_param):
        super(UpdateAlarmRuleInfoHybridRequest, self).__init__("/v4/monitor/update-alarm-rule-info", "POST", "monitor", "application/json")
...
class UpdateAlarmRuleInfoHybridRequestParam(object):

    def __init__(self, region_id, name, alarm_rule_id, contact_group_list, level, rules, notify_type, desc=None, notify_start=None, notify_end=None, notify_weekdays=None, recover_notify=None, repeat_times=None, silence_time=None):
        """
        ...
        :param level: 取值范围：1：紧急2：重要3：次要4：提示根据以上范围取值。
        :param rules: 具体匹配规则 注意:此参数为数组
