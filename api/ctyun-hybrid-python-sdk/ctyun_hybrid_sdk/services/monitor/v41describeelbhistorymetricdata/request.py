...
class V41describeELBHistoryMetricDataRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(V41describeELBHistoryMetricDataRequest, self).__init__("/v4.1/monitor/query-elb-historymetricdata", "POST", "monitor", "application/json")
...
class V41describeELBHistoryMetricDataRequestParam(object):
