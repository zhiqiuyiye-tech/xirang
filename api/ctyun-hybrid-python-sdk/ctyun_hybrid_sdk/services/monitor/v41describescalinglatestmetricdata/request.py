...
class V41describeScalingLatestMetricDataRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(V41describeScalingLatestMetricDataRequest, self).__init__("/v4.1/monitor/query-scaling-latestmetricdata", "POST", "monitor", "application/json")
...
class V41describeScalingLatestMetricDataRequestParam(object):
