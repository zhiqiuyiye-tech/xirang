...
class V41describeTrafficHistoryMetricDataRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(V41describeTrafficHistoryMetricDataRequest, self).__init__("/v4.1/monitor/query-traffic-historymetricdata", "POST", "monitor", "application/json")
...
class V41describeTrafficHistoryMetricDataRequestParam(object):
