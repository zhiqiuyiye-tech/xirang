...
class QueryVmCpuTopHybridRequest(CTYunRequest):
    """
    调用此接口可查询用户在指定资源池云主机监控中cpu使用率Top-N。
    """

    def __init__(self, request_param):
        super(QueryVmCpuTopHybridRequest, self).__init__("/v4/monitor/query-cpu-top", "POST", "monitor", "application/json")
...
class QueryVmCpuTopHybridRequestParam(object):
