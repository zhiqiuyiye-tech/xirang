...
class QueryAlertTopOverviewHybridRequest(CTYunRequest):
    """
    查询告警历史告警数TOP细分图表
    """

    def __init__(self, request_param):
        super(QueryAlertTopOverviewHybridRequest, self).__init__("/v4/monitor/query-alert-top-overview", "POST", "monitor", "application/json")
...
class QueryAlertTopOverviewHybridRequestParam(object):

    def __init__(self, region_id, start_time, end_time, ):
        """
