...
class QueryMetricDataVarianceHybridRequest(CTYunRequest):
    """
    查询某个设备的历史数据，以period为周期，返回每个周期内的方差
    """

    def __init__(self, request_param):
        super(QueryMetricDataVarianceHybridRequest, self).__init__("/v4/monitor/query-metricdata-variance", "POST", "monitor", "application/json")
...
class QueryMetricDataVarianceHybridRequestParam(object):
