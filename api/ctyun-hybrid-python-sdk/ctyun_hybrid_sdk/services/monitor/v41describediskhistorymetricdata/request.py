...
class V41describeDiskHistoryMetricDataRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(V41describeDiskHistoryMetricDataRequest, self).__init__("/v4.1/monitor/query-disk-historymetricdata", "POST", "monitor", "application/json")
...
class V41describeDiskHistoryMetricDataRequestParam(object):
