...
class DeleteAlarmRuleHybridRequest(CTYunRequest):
    """
    调用此接口可删除创建告警规则
    """

    def __init__(self, request_param):
        super(DeleteAlarmRuleHybridRequest, self).__init__("/v4/monitor/delete-alarm-rule", "POST", "monitor", "application/json")
...
class DeleteAlarmRuleHybridRequestParam(object):
