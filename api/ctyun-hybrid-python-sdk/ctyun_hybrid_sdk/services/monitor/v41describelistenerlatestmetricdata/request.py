...
class V41describeListenerLatestMetricDataRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(V41describeListenerLatestMetricDataRequest, self).__init__("/v4.1/monitor/query-listener-latestmetricdata", "POST", "monitor", "application/json")
...
class V41describeListenerLatestMetricDataRequestParam(object):
