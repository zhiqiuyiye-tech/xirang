...
class QueryVmHostDiskTopHybridRequest(CTYunRequest):
    """
    调用此接口可查询用户在指定资源池宿主机监控中磁盘使用率Top-N。
    """

    def __init__(self, request_param):
        super(QueryVmHostDiskTopHybridRequest, self).__init__("/v4/monitor/query-ph-disk-top", "POST", "monitor", "application/json")
...
class QueryVmHostDiskTopHybridRequestParam(object):
