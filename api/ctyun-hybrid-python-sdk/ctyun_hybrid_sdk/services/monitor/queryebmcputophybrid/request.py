...
class QueryEbmCpuTopHybridRequest(CTYunRequest):
    """
    调用此接口可查询用户在指定资源池裸金属监控中cpu使用率Top-N。
    """

    def __init__(self, request_param):
        super(QueryEbmCpuTopHybridRequest, self).__init__("/v4/monitor/query-baremetal-cpu-top", "POST", "monitor", "application/json")
...
class QueryEbmCpuTopHybridRequestParam(object):
