...
class QueryEbmDiskTopHybridRequest(CTYunRequest):
    """
    调用此接口可查询用户在指定资源池裸金属监控中磁盘使用率Top-N。
    """

    def __init__(self, request_param):
        super(QueryEbmDiskTopHybridRequest, self).__init__("/v4/monitor/query-baremetal-disk-top", "POST", "monitor", "application/json")
...
class QueryEbmDiskTopHybridRequestParam(object):
