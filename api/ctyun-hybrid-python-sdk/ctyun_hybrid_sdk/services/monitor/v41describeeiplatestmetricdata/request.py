...
class V41describeEIPLatestMetricDataRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(V41describeEIPLatestMetricDataRequest, self).__init__("/v4.1/monitor/query-eip-latestmetricdata", "POST", "monitor", "application/json")
...
class V41describeEIPLatestMetricDataRequestParam(object):
