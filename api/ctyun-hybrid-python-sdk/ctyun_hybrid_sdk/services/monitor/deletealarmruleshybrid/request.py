...
class DeleteAlarmRulesHybridRequest(CTYunRequest):
    """
    调用此接口可批量删除多个创建告警规则
    """

    def __init__(self, request_param):
        super(DeleteAlarmRulesHybridRequest, self).__init__("/v4/monitor/delete-alarm-rules", "POST", "monitor", "application/json")
...
class DeleteAlarmRulesHybridRequestParam(object):
