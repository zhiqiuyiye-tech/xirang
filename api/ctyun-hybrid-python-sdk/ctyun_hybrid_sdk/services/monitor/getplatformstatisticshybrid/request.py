...
class GetPlatformStatisticsHybridRequest(CTYunRequest):
    """
    查询平台监控聚合监控
    """

    def __init__(self, request_param):
        super(GetPlatformStatisticsHybridRequest, self).__init__("/v4/monitor/get-platform-statistics", "GET", "monitor", "")
...
class GetPlatformStatisticsHybridRequestParam(object):

    def __init__(self, type, from_value, to, instance=None, server=None, db=None):
        """
