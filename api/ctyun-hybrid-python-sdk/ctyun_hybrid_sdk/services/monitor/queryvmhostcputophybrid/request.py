...
class QueryVmHostCpuTopHybridRequest(CTYunRequest):
    """
    调用此接口可查询用户在指定资源池宿主机监控中cpu使用率Top-N。
    """

    def __init__(self, request_param):
        super(QueryVmHostCpuTopHybridRequest, self).__init__("/v4/monitor/query-ph-cpu-top", "POST", "monitor", "application/json")
...
class QueryVmHostCpuTopHybridRequestParam(object):
