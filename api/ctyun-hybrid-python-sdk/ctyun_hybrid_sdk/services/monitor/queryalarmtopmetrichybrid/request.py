...
class QueryAlarmTopMetricHybridRequest(CTYunRequest):
    """
    调用此接口可查询指定资源池下告警Top指标。
    """

    def __init__(self, request_param):
        super(QueryAlarmTopMetricHybridRequest, self).__init__("/v4/monitor/query-alarm-top-metric", "GET", "monitor", "")
...
class QueryAlarmTopMetricHybridRequestParam(object):
