...
class QueryVmHostMemTopHybridRequest(CTYunRequest):
    """
    调用此接口可查询用户在指定资源池宿主机监控中内存使用率Top-N。
    """

    def __init__(self, request_param):
        super(QueryVmHostMemTopHybridRequest, self).__init__("/v4/monitor/query-ph-mem-top", "POST", "monitor", "application/json")
...
class QueryVmHostMemTopHybridRequestParam(object):
