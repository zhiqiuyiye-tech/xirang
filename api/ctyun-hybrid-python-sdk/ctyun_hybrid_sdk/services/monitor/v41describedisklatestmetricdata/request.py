...
class V41describeDiskLatestMetricDataRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(V41describeDiskLatestMetricDataRequest, self).__init__("/v4.1/monitor/query-disk-latestmetricdata", "POST", "monitor", "application/json")
...
class V41describeDiskLatestMetricDataRequestParam(object):
