...
class V41describeSFSHistoryMetricDataRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(V41describeSFSHistoryMetricDataRequest, self).__init__("/v4.1/monitor/query-sfs-historymetricdata", "POST", "monitor", "application/json")
...
class V41describeSFSHistoryMetricDataRequestParam(object):
