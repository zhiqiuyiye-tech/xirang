...
class QueryAlarmTotalHybridRequest(CTYunRequest):
    """
    调用此接口可查询指定资源池告警数量统计。
    """

    def __init__(self, request_param):
        super(QueryAlarmTotalHybridRequest, self).__init__("/v4.1/monitor/query-alarm-total", "GET", "monitor", "")
...
class QueryAlarmTotalHybridRequestParam(object):

    def __init__(self, region_id, start_time, end_time, ):
        """
        :param region_id: 资源池ID
        :param start_time: 起始时间戳，秒级
