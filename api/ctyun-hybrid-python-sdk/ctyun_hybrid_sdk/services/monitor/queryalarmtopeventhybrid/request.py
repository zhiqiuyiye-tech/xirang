...
class QueryAlarmTopEventHybridRequest(CTYunRequest):
    """
    调用此接口可查询指定资源池下告警Top事件。
    """

    def __init__(self, request_param):
        super(QueryAlarmTopEventHybridRequest, self).__init__("/v4/monitor/query-alarm-top-event", "GET", "monitor", "")
...
class QueryAlarmTopEventHybridRequestParam(object):
