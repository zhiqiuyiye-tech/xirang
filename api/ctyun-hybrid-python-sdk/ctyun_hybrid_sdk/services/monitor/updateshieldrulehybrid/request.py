...
class UpdateShieldRuleHybridRequest(CTYunRequest):
    """
    修改告警屏蔽规则
    """

    def __init__(self, request_param):
        super(UpdateShieldRuleHybridRequest, self).__init__("/v4/monitor/update-shield-rule", "POST", "monitor", "application/json")
...
class UpdateShieldRuleHybridRequestParam(object):

    def __init__(self, id, region_id, alarm_rule_id, work_start_time, work_end_time, week_days, start_time, end_time, process_policy, status=None, description=None):
        """
        :param id: 告警屏蔽规则ID
        ...
        :param week_days: 1、2、3、4、5、6、0 注意:此参数为数组
