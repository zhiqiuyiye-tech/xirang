...
class QueryMetricDataMinHybridRequest(CTYunRequest):
    """
    查询某个设备的历史数据，以period为周期，返回每个周期内的最小值
    """

    def __init__(self, request_param):
        super(QueryMetricDataMinHybridRequest, self).__init__("/v4/monitor/query-metricdata-min", "POST", "monitor", "application/json")
...
class QueryMetricDataMinHybridRequestParam(object):
