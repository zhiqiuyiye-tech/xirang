...
class QueryTotalEbmTrendHybridRequest(CTYunRequest):
    """
    资源池下所有裸金属统计出总的时序指标性能数据。
    """

    def __init__(self, request_param):
        super(QueryTotalEbmTrendHybridRequest, self).__init__("/v4/monitor/query-baremetal-trend", "POST", "monitor", "application/json")
...
class QueryTotalEbmTrendHybridRequestParam(object):
