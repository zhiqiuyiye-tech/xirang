...
class QueryVmDiskTopHybridRequest(CTYunRequest):
    """
    调用此接口可查询用户在指定资源池云主机监控中磁盘使用率Top-N。
    """

    def __init__(self, request_param):
        super(QueryVmDiskTopHybridRequest, self).__init__("/v4/monitor/query-disk-top", "POST", "monitor", "application/json")
...
class QueryVmDiskTopHybridRequestParam(object):
