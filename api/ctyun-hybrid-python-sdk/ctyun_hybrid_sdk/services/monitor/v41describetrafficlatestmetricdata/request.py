...
class V41describeTrafficLatestMetricDataRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(V41describeTrafficLatestMetricDataRequest, self).__init__("/v4.1/monitor/query-traffic-latestmetricdata", "POST", "monitor", "application/json")
...
class V41describeTrafficLatestMetricDataRequestParam(object):
