...
class V41describeBaremetalHistoryMetricDataRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(V41describeBaremetalHistoryMetricDataRequest, self).__init__("/v4.1/monitor/query-baremetal-historymetricdata", "POST", "monitor", "application/json")
...
class V41describeBaremetalHistoryMetricDataRequestParam(object):
