...
class QueryTotalVmTrendHybridRequest(CTYunRequest):
    """
    资源池下所有云主机统计出总的时序指标性能数据。
    """

    def __init__(self, request_param):
        super(QueryTotalVmTrendHybridRequest, self).__init__("/v4/monitor/query-vm-trend", "POST", "monitor", "application/json")
...
class QueryTotalVmTrendHybridRequestParam(object):
