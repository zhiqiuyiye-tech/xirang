...
class SfsRollbackSnapshotSfsRequest(CTYunRequest):
    """
    弹性文件回滚快照
    """

    def __init__(self, request_param):
        super(SfsRollbackSnapshotSfsRequest, self).__init__("/v4/sfs/snapshot/rollback", "POST", "sfs", "application/json")
...
class SfsRollbackSnapshotSfsRequestParam(object):

    def __init__(self, region_id, snapshot_id, uid, ):
        """
