...
class SfsRefundSfsRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(SfsRefundSfsRequest, self).__init__("/v4/sfs/refund-sfs", "POST", "sfs", "application/json")
...
class SfsRefundSfsRequestParam(object):

    def __init__(self, sfs_uid, region_id, client_token=None):
        """
        :param sfs_uid: 资源id
