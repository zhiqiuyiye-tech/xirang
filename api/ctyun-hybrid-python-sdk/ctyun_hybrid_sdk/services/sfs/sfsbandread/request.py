...
class SfsBandReadRequest(CTYunRequest):
    """
    查询文件系统历史读带宽流量信息，fuser_last_updated取得文件系统在云管的更新时间，UID兼容了云管ID和底层UUID
    """

    def __init__(self, request_param):
        super(SfsBandReadRequest, self).__init__("/v4/sfs/band-read", "GET", "sfs", "application/json")
...
class SfsBandReadRequestParam(object):
