...
class SfsChangeVpcSfsRequest(CTYunRequest):
    """
    文件系统VPC换绑权限组
    """

    def __init__(self, request_param):
        super(SfsChangeVpcSfsRequest, self).__init__("/v4/sfs/vpc-change-permission", "POST", "sfs", "application/json")
...
class SfsChangeVpcSfsRequestParam(object):

    def __init__(self, permission_group_fuid, region_id, sfs_uid, vpc_id, ):
        """
