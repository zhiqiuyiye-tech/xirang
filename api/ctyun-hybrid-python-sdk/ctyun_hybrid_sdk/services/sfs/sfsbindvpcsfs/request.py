...
class SfsBindVpcSfsRequest(CTYunRequest):
    """
    文件系统VPC绑定权限组
    """

    def __init__(self, request_param):
        super(SfsBindVpcSfsRequest, self).__init__("/v4/sfs/vpc-bind-permission", "POST", "sfs", "application/json")
...
class SfsBindVpcSfsRequestParam(object):

    def __init__(self, region_id, vpc_id, sfs_uid, permission_group_fuid, ):
        """
