...
class PermissionRuleListRequest(CTYunRequest):
    """
    返回权限组规则描述信息
    """

    def __init__(self, request_param):
        super(PermissionRuleListRequest, self).__init__("/v4/sfs/permission-rule/list", "GET", "sfs", "")
...
class PermissionRuleListRequestParam(object):

    def __init__(self, region_id, permission_group_id, page_no=None, page_size=None):
        """
