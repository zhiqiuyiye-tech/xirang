...
class HistoryStorageRequest(CTYunRequest):
    """
    查询文件系统已使用容量历史信息，fuser_last_updated取得文件系统在云管的更新时间，UID兼容了云管ID和底层UUID
    """

    def __init__(self, request_param):
        super(HistoryStorageRequest, self).__init__("/v4/sfs/history-storage", "GET", "sfs", "application/json")
...
class HistoryStorageRequestParam(object):
