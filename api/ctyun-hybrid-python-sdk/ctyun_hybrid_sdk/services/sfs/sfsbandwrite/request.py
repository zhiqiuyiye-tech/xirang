...
class SfsBandWriteRequest(CTYunRequest):
    """
    查询文件系统历史写带宽流量信息，fuser_last_updated取得文件系统在云管的更新时间，UID兼容了云管ID和底层UUID
    """

    def __init__(self, request_param):
        super(SfsBandWriteRequest, self).__init__("/v4/sfs/band-write", "GET", "sfs", "application/json")
...
class SfsBandWriteRequestParam(object):
