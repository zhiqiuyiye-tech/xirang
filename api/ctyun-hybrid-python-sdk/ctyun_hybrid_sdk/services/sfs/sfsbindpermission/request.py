...
class SfsBindPermissionRequest(CTYunRequest):
    """
    文件系统VPC绑定权限组
    """

    def __init__(self, request_param):
        super(SfsBindPermissionRequest, self).__init__("/v4/sfs/bind-permission", "POST", "sfs", "application/json")
...
class SfsBindPermissionRequestParam(object):
