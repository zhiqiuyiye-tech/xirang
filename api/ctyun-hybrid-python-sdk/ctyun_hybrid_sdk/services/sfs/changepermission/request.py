...
class ChangePermissionRequest(CTYunRequest):
    """
    v1 accessGroupId为int类型，v2为string类型
    """

    def __init__(self, request_param):
        super(ChangePermissionRequest, self).__init__("/v4/sfs/change-permission", "POST", "sfs", "application/json")
...
class ChangePermissionRequestParam(object):
