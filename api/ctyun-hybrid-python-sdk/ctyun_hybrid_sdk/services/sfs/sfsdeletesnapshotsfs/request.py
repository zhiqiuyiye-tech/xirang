...
class SfsDeleteSnapshotSfsRequest(CTYunRequest):
    """
    弹性文件删除快照
    """

    def __init__(self, request_param):
        super(SfsDeleteSnapshotSfsRequest, self).__init__("/v4/sfs/snapshot/delete", "POST", "sfs", "application/json")
...
class SfsDeleteSnapshotSfsRequestParam(object):
