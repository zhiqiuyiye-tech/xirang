...
class DelQuotaRequest(CTYunRequest):
    """
    删除文件系统目录配额
    """

    def __init__(self, request_param):
        super(DelQuotaRequest, self).__init__("/v4/sfs/del-quota", "POST", "sfs", "application/json")
...
class DelQuotaRequestParam(object):

    def __init__(self, region_id, uid, quota_sub_dir_name, ):
        """
        :param region_id: 资源池ID
        :param uid: 兼容了云管ID和底层UUID
        :param quota_sub_dir_name: 文件系统一级子目录名称
        """
