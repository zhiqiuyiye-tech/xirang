...
class ListFileClusterNodesRequest(CTYunRequest):
    """
    查询文件存储集群存储节点列表
    """

    def __init__(self, request_param):
        super(ListFileClusterNodesRequest, self).__init__("/v4/file-storage/list-node", "GET", "sfs", "")
...
class ListFileClusterNodesRequestParam(object):

    def __init__(self, region_id, storage_type=None, cluster_id=None, pool_id=None, page_no=None, page_size=None):
        """
        :param region_id: 资源池ID
        :param storage_type: 指定文件系统类型筛选集群
