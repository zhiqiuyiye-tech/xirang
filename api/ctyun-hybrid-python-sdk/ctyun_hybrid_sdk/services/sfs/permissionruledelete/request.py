...
class PermissionRuleDeleteRequest(CTYunRequest):
    """
    弹性文件删除已有权限组规则
    """

    def __init__(self, request_param):
        super(PermissionRuleDeleteRequest, self).__init__("/v4/sfs/permission-rule/delete", "POST", "sfs", "application/json")
...
class PermissionRuleDeleteRequestParam(object):

    def __init__(self, region_id, permission_rule_id, permission_group_id=None):
        """
        :param region_id: 资源池ID
        :param permission_group_id: 公有云未传该字段，这个是没有意义，只做v1兼容占位，不做检测
