...
class SfsUnbindPermissionRequest(CTYunRequest):
    """
    文件系统的VPC解绑权限组
    """

    def __init__(self, request_param):
        super(SfsUnbindPermissionRequest, self).__init__("/v4/sfs/unbind-permission", "POST", "sfs", "application/json")
...
class SfsUnbindPermissionRequestParam(object):

    def __init__(self, region_id, uid, vpc_id, permission_group_id, ):
        """
        :param region_id: 资源池
        :param uid: 文件系统ID
        :param vpc_id: vpc ID
