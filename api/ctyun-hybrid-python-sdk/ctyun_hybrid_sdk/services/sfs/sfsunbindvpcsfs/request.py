...
class SfsUnbindVpcSfsRequest(CTYunRequest):
    """
    文件系统VPC解绑权限组
    """

    def __init__(self, request_param):
        super(SfsUnbindVpcSfsRequest, self).__init__("/v4/sfs/vpc-unbind-permission", "POST", "sfs", "application/json")
...
class SfsUnbindVpcSfsRequestParam(object):

    def __init__(self, region_id, sfs_uid, vpc_id, permission_group_fuid, ):
        """
        :param region_id: 资源池
        :param sfs_uid: 弹性文件功能系统唯一 ID
        :param vpc_id: vpc ID
