...
class ListHealthCheckRequest(CTYunRequest):
    """
    获取健康检查列表
    """

    def __init__(self, request_param):
        super(ListHealthCheckRequest, self).__init__("/v4/elb/list-health-check", "GET", "ctelb", "")
...
class ListHealthCheckRequestParam(object):

    def __init__(self, region_id, client_token=None, ids=None, name=None, project_id=None):
        """
        :param client_token: 客户端存根，用于保证订单幂等性。要求单个云平台账户内唯一（非必填，并且此字段在私有云不具有实际意义）
        :param region_id: 区域ID
        :param ids: 健康检查ID列表（按以往文档IDs为，隔开的字符传，暂定为String）
