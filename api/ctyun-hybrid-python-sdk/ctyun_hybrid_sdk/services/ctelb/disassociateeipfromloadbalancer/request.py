...
class DisassociateEipFromLoadBalancerRequest(CTYunRequest):
    """
    解绑弹性 IP
    """

    def __init__(self, request_param):
        super(DisassociateEipFromLoadBalancerRequest, self).__init__("/v4/elb/disassociate-eip-from", "POST", "ctelb", "application/json")
...
class DisassociateEipFromLoadBalancerRequestParam(object):

    def __init__(self, region_id, id, eip_id, client_token=None):
        """
