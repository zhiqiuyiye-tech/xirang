...
class RenewLbOpenapiRequest(CTYunRequest):
    """
    续订性能保障型负载均衡实例，仅支持性能保障型的续订
    """

    def __init__(self, request_param):
        super(RenewLbOpenapiRequest, self).__init__("/v4/elb/renew-pgelb", "POST", "ctelb", "application/json")
...
class RenewLbOpenapiRequestParam(object):
