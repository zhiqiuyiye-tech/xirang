...
class CreateRuleNewRequest(CTYunRequest):
    """
    创建转发规则new，对齐公有云出入参数   
    ...
    * 不支持 3.0，因为 3.0 是异步逻辑，4.0 是同步逻辑
    ...
    def __init__(self, request_param):
        super(CreateRuleNewRequest, self).__init__("/v4/elb/create-rule-new", "POST", "ctelb", "application/json")
...
class CreateRuleNewRequestParam(object):
