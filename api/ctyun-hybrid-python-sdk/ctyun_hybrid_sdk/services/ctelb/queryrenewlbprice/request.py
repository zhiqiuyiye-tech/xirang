...
class QueryRenewLbPriceRequest(CTYunRequest):
    """
    性能保障型负载均衡实例续订询价
    """

    def __init__(self, request_param):
        super(QueryRenewLbPriceRequest, self).__init__("/v4/elb/query-renew-price", "POST", "ctelb", "application/json")
...
class QueryRenewLbPriceRequestParam(object):

    def __init__(self, client_token, region_id, elb_id, cycle_type, cycle_count, ):
        """
