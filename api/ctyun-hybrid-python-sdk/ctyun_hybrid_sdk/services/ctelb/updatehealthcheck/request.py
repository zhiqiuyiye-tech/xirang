...
class UpdateHealthCheckRequest(CTYunRequest):
    """
    更新健康检查
    """

    def __init__(self, request_param):
        super(UpdateHealthCheckRequest, self).__init__("/v4/elb/update-health-check", "POST", "ctelb", "application/json")
...
class UpdateHealthCheckRequestParam(object):
