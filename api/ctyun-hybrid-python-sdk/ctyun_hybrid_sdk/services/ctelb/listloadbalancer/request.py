...
class ListLoadBalancerRequest(CTYunRequest):
    """
    查看负载均衡实例列表
    """

    def __init__(self, request_param):
        super(ListLoadBalancerRequest, self).__init__("/v4/elb/list-loadbalancer", "GET", "ctelb", "")
...
class ListLoadBalancerRequestParam(object):

    def __init__(self, region_id, ids=None, resource_type=None, name=None, subnet_id=None, ignore_channel=None, project_id=None):
        """
