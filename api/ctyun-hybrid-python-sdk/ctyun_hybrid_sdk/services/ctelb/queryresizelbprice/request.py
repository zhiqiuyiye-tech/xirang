...
class QueryResizeLbPriceRequest(CTYunRequest):
    """
    性能保障型负载均衡变配询价
    """

    def __init__(self, request_param):
        super(QueryResizeLbPriceRequest, self).__init__("/v4/elb/query-modify-price", "POST", "ctelb", "application/json")
...
class QueryResizeLbPriceRequestParam(object):
