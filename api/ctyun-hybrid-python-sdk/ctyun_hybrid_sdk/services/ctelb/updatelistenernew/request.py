...
class UpdateListenerNewRequest(CTYunRequest):
    """
    更新监听器，对齐公有云返回   
    ...
    * 不支持 3.0，因为 3.0 支持更新的参数与 4.0 不一致
    ...
    def __init__(self, request_param):
        super(UpdateListenerNewRequest, self).__init__("/v4/elb/update-listener-new", "POST", "ctelb", "application/json")
...
class DefaultAction(object):
    ...
    def __init__(self, type, forward_config=None, redirect_listener_id=None):
        ...
        :param type: 默认规则动作类型。取值范围： forward、redirect、deny(目前暂不支持配置为deny)，当默认规则动作不为null时，此参数必填，
        """
...
class UpdateListenerNewRequestParam(object):

    def __init__(self, region_id, id, name=None, description=None, default_action=None, forwarded_for_enabled=None, access_control_id=None, access_control_type=None, client_certificate_id=None, certificate_id=None, ca_enabled=None, client_token=None, nat_mode=None, forwarded_proto_enabled=None, forwarded_port_enabled=None, http2_enabled=None):
        """
        ...
        :param default_action: 默认规则动作
        :param forwarded_for_enabled: x forward for功能。false（未开启）、true（开）
        :param access_control_id: 访问控制ID
        :param access_control_type: 访问控制类型。Close（未启用）、White（白名单）、Black（黑名单）
        ...
        :param forwarded_proto_enabled: x forworded Proto功能：0-未开启，1-开启
        :param forwarded_port_enabled: x forworded Port功能：0-未开启，1-开启
        :param http2_enabled: 开启http2.0，仅支持https类型，0未开启，1开启
        """
