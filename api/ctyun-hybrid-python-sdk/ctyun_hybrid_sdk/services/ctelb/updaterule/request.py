...
class UpdateRuleRequest(CTYunRequest):
    """
    更新转发规则
    """

    def __init__(self, request_param):
        super(UpdateRuleRequest, self).__init__("/v4/elb/update-rule", "POST", "ctelb", "application/json")
...
class Conditions(object):
    ...
    def __init__(self, type, server_name_config=None, url_path_config=None):
        """
        :param server_name_config: 服务名称，type为server_name时必填
        :param type: 类型。取值范围：server_name（服务名称）、url_path（匹配路径）
        :param url_path_config: 匹配路径，type为url_path时必填
        """
...
class UrlPathConfig(object):
    ...
    def __init__(self, match_type=None, url_paths=None):
        """
    ...
    def set_url_paths(self, url_paths):
        """
        :param url_paths: 匹配路径
        """
        self.url_paths = url_paths
...
class UpdateRuleRequestParam(object):
