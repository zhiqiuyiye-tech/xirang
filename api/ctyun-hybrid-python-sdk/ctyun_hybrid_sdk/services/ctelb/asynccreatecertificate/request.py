...
class AsyncCreateCertificateRequest(CTYunRequest):
    """
    该接口为适配3.0资源池接口，可兼容4.0资源池
    """

    def __init__(self, request_param):
        super(AsyncCreateCertificateRequest, self).__init__("/v4/elb/async-create-certificate", "POST", "ctelb", "application/json")
...
class AsyncCreateCertificateRequestParam(object):

    def __init__(self, region_id, name, certificate, type, client_token, description=None, private_key=None, az_name=None, project_id=None):
        """
        :param region_id: 区域ID
        :param name: 监听器证书名称,支持字母、中文、数字，下划线，连字符，中文 / 英文字母开头，长度 2 - 32,不能重名
        :param description: 支持字母、中文、数字, 特殊字符：~!@#$%^&*()_-+= <>?:{},./;'[]·！@#￥%……&*（） —— -+={}\\|《》？：“”【】、；‘'，。、，不能以 http: / https: 开头，长度 0 - 128
