...
class ElbBindLabelOpenapiRequest(CTYunRequest):
    """
    负载均衡绑定标签
    """

    def __init__(self, request_param):
        super(ElbBindLabelOpenapiRequest, self).__init__("/v4/elb/bind-label", "POST", "ctelb", "application/json")
...
class ElbBindLabelOpenapiRequestParam(object):

    def __init__(self, region_id, elb_id, label_key, label_value, ):
        """
