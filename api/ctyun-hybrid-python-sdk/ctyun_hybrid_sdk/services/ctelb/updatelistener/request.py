...
class UpdateListenerRequest(CTYunRequest):
    """
    更新监听器   
    ...
    * 不支持 3.0，因为 3.0 支持更新的参数与 4.0 不一致
    ...
    def __init__(self, request_param):
        super(UpdateListenerRequest, self).__init__("/v4/elb/update-listener", "POST", "ctelb", "application/json")
...
class UpdateListenerRequestParam(object):
