...
class CreateSaml2ConfigRequest(CTYunRequest):
    """
    创建SAML2.0 认证配置
    """

    def __init__(self, request_param):
        super(CreateSaml2ConfigRequest, self).__init__("/v1/auth/saml2/create", "POST", "ssoconfig", "application/json")
...
class CreateSaml2ConfigRequestParam(object):

    def __init__(self, name, sp_metadata, issuer=None):
        """
        :param issuer:  长度最长200,如果不填默认取spMetadata的entityID
        :param name: 长度为2到63
