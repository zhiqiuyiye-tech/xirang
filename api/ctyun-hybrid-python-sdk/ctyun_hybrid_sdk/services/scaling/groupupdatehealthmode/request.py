...
class GroupUpdateHealthModeRequest(CTYunRequest):
    """
    修改弹性伸缩组的健康检查方式
    """

    def __init__(self, request_param):
        super(GroupUpdateHealthModeRequest, self).__init__("/v4/scaling/group/update-health-mode", "POST", "scaling", "application/json")
...
class GroupUpdateHealthModeRequestParam(object):

    def __init__(self, region_id, group_id, health_mode, ):
        """
        :param region_id: 资源池id
        :param group_id: 伸缩组ID
        :param health_mode: 健康检查方式：1代表云服务器健康检查，2代表弹性负载均衡健康检查，只有伸缩组使用负载均衡时支持2
        """
