...
class RuleDeleteScheduledRequest(CTYunRequest):
    """
    删除一个定时任务
    """

    def __init__(self, request_param):
        super(RuleDeleteScheduledRequest, self).__init__("/v4/scaling/rule/delete-scheduled", "POST", "scaling", "application/json")
...
class RuleDeleteScheduledRequestParam(object):
