...
class GroupInstanceMoveInRequest(CTYunRequest):
    """
    手动添加云主机
    """

    def __init__(self, request_param):
        super(GroupInstanceMoveInRequest, self).__init__("/v4/scaling/group/instance-move-in", "POST", "scaling", "application/json")
...
class GroupInstanceMoveInRequestParam(object):

    def __init__(self, instance_uuid_list, region_id, group_id, ):
        """
        :param instance_uuid_list: 云主机ID列表，云主机必须和伸缩组在同一vpc下，且为运行状态，且不在其他伸缩组中 注意:此参数为数组
