...
class GroupProtectDisableRequest(CTYunRequest):
    """
    关闭云主机保护
    """

    def __init__(self, request_param):
        super(GroupProtectDisableRequest, self).__init__("/v4/scaling/group/protect-disable", "POST", "scaling", "application/json")
...
class GroupProtectDisableRequestParam(object):

    def __init__(self, region_id, group_id, instance_id_list, ):
        """
