...
class RuleQueryAlarmRequest(CTYunRequest):
    """
    查询报警任务的信息
    """

    def __init__(self, request_param):
        super(RuleQueryAlarmRequest, self).__init__("/v4/scaling/rule/query-alarm", "POST", "scaling", "application/json")
