...
class RuleStartAlarmRequest(CTYunRequest):
    """
    启用一条报警策略
    """

    def __init__(self, request_param):
        super(RuleStartAlarmRequest, self).__init__("/v4/scaling/rule/start-alarm", "POST", "scaling", "application/json")
...
class RuleStartAlarmRequestParam(object):
