...
class RuleStopAlarmRequest(CTYunRequest):
    """
    停用一条报警策略
    """

    def __init__(self, request_param):
        super(RuleStopAlarmRequest, self).__init__("/v4/scaling/rule/stop-alarm", "POST", "scaling", "application/json")
