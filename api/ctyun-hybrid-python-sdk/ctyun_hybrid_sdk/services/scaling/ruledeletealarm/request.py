...
class RuleDeleteAlarmRequest(CTYunRequest):
    """
    删除一个告警策略
    """

    def __init__(self, request_param):
        super(RuleDeleteAlarmRequest, self).__init__("/v4/scaling/rule/delete-alarm", "POST", "scaling", "application/json")
...
class RuleDeleteAlarmRequestParam(object):

    def __init__(self, region_id, rule_id, group_id=None):
        """
        :param region_id: 资源池ID
        :param rule_id: 报警任务ID（规则ID）
        :param group_id: 报警伸缩组ID（底层不需要该参数，公有云必选，故只做接收处理）
        """
