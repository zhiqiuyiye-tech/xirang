...
class GroupInstanceMoveOutRequest(CTYunRequest):
    """
    从一个伸缩组移出一台或多台ECS实例
    """

    def __init__(self, request_param):
        super(GroupInstanceMoveOutRequest, self).__init__("/v4/scaling/group/instance-move-out", "POST", "scaling", "application/json")
...
class GroupInstanceMoveOutRequestParam(object):

    def __init__(self, region_id, group_id, instance_id_list, ):
        """
        :param region_id: 区域id
        :param group_id: 伸缩组ID
        :param instance_id_list: 伸缩实例ID 列表 注意:此参数为数组
        """
