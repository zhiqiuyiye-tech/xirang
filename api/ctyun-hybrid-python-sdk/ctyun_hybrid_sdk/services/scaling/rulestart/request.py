...
class RuleStartRequest(CTYunRequest):
    """
    启用伸缩组中指定策略
    """

    def __init__(self, request_param):
        super(RuleStartRequest, self).__init__("/v4/scaling/rule/start", "POST", "scaling", "application/json")
...
class RuleStartRequestParam(object):
