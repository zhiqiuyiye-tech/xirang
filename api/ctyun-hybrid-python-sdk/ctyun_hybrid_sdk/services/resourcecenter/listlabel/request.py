...
class ListLabelRequest(CTYunRequest):
    """
    查询标签列表
    """

    def __init__(self, request_param):
        super(ListLabelRequest, self).__init__("/v4/resource-center/label/list", "POST", "resourcecenter", "application/json")
    ...
    def get_body_param(self):
        ...
        if self.parameters.label_types is not None:
            body_param["labelTypes"] = self.parameters.label_types
...
class ListLabelRequestParam(object):

    def __init__(self, label_types, vdc_id=None, user_id=None, label_keys=None, fuzzy_label_key=None, label_values=None, fuzzy_label_value=None, label_ids=None, fuzzy_label_id=None, fuzzy_content=None, sort=None, asc=None, page_size=None, page=None):
        """
        :param vdc_id: 查询预置标签必传
        :param user_id: 查询单个用户自定义标签
        :param label_types: (数组)过滤标签类型 注意:此参数为数组
    ...
    def check_param(self):
        ...
        if self.label_types is None:
            raise Exception("label_types can not None")
