...
class ListPublicLabelRequest(CTYunRequest):
    """
    查询自定义标签列表
    """

    def __init__(self, request_param):
        super(ListPublicLabelRequest, self).__init__("/v4/resource-center/label/list/public", "POST", "resourcecenter", "application/json")
...
class ListPublicLabelRequestParam(object):

    def __init__(self, label_keys=None, fuzzy_label_key=None, label_values=None, fuzzy_label_value=None, label_ids=None, fuzzy_label_id=None, fuzzy_content=None, sort=None, asc=None, page_size=None, page=None):
        """
        ...
        :param sort: 指定排序字段
        :param asc: 与sort组合使用
        :param page_size: 默认10，最大100，超过100返回100
        :param page: -1 返回全量数据不分页，输入0或者不输入默认10
        """
