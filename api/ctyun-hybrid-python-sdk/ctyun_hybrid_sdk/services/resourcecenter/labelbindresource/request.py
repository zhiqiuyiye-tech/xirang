...
class LabelBindResourceRequest(CTYunRequest):
    """
    标签绑定资源
    """

    def __init__(self, request_param):
        super(LabelBindResourceRequest, self).__init__("/v4/resource-center/label/bind", "POST", "resourcecenter", "application/json")
...
class Resource(object):
    ...
    def __init__(self, resource_id, label_ids, ):
        """
        :param resource_id: 绑定资源ID
        :param label_ids: 绑定标签ID数组
        """
...
class LabelBindResourceRequestParam(object):

    def __init__(self, resources, ):
        """
        :param resources: 绑定资源数组 注意:此参数为数组
        """
