...
class DeletePresetLabelRequest(CTYunRequest):
    """
    删除标签同时`解绑`其关联的所有资源
    """

    def __init__(self, request_param):
        super(DeletePresetLabelRequest, self).__init__("/v4/resource-center/label/delete/preset", "POST", "resourcecenter", "application/json")
...
class DeletePresetLabelRequestParam(object):
