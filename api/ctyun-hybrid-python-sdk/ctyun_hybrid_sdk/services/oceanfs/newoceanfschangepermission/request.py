...
class NewOceanfsChangePermissionRequest(CTYunRequest):
    """
    海量文件VPC换绑权限组（新）
    """

    def __init__(self, request_param):
        super(NewOceanfsChangePermissionRequest, self).__init__("/v4/oceanfs/vpc-change-permission", "POST", "oceanfs", "application/json")
...
class NewOceanfsChangePermissionRequestParam(object):

    def __init__(self, region_id, permission_group_fuid, sfs_uid, vpc_id, ):
        """
