...
class OceanfsUnbindPermissionRequest(CTYunRequest):
    """
    文件系统VPC解绑权限组
    """

    def __init__(self, request_param):
        super(OceanfsUnbindPermissionRequest, self).__init__("/v4/oceanfs/unbind-permission", "POST", "oceanfs", "application/json")
...
class OceanfsUnbindPermissionRequestParam(object):

    def __init__(self, region_id, sfs_uid, vpc_id, permission_group_fuid=None, permission_group_id=None):
        """
        :param region_id: 资源池ID
        :param permission_group_fuid: 权限组fuid(混合云暂不支持，可填入权限组ID值) permissionGroupFuid或permissionGroupID必传其中一个
