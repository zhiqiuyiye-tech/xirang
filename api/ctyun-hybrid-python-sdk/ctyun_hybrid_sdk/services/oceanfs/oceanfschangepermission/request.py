...
class OceanfsChangePermissionRequest(CTYunRequest):
    """
    文件系统VPC换绑权限组
    """

    def __init__(self, request_param):
        super(OceanfsChangePermissionRequest, self).__init__("/v4/oceanfs/change-permission", "POST", "oceanfs", "application/json")
...
class OceanfsChangePermissionRequestParam(object):
