...
class OceanfsBindPermissionRequest(CTYunRequest):
    """
    文件系统VPC绑定权限组
    """

    def __init__(self, request_param):
        super(OceanfsBindPermissionRequest, self).__init__("/v4/oceanfs/bind-permission", "POST", "oceanfs", "application/json")
...
class OceanfsBindPermissionRequestParam(object):
