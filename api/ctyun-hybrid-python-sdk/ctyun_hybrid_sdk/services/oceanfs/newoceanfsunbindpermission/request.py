...
class NewOceanfsUnbindPermissionRequest(CTYunRequest):
    """
    海量文件VPC解绑权限组（新）
    """

    def __init__(self, request_param):
        super(NewOceanfsUnbindPermissionRequest, self).__init__("/v4/oceanfs/vpc-unbind-permission", "POST", "oceanfs", "application/json")
...
class NewOceanfsUnbindPermissionRequestParam(object):
