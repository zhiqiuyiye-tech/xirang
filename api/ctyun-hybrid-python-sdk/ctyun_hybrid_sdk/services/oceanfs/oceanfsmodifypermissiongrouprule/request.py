...
class OceanfsModifyPermissionGroupRuleRequest(CTYunRequest):
    """
    海量文件修改权限组规则
    """

    def __init__(self, request_param):
        super(OceanfsModifyPermissionGroupRuleRequest, self).__init__("/v4/oceanfs/permission-rule/modify-permission-rule", "POST", "oceanfs", "application/json")
...
class OceanfsModifyPermissionGroupRuleRequestParam(object):

    def __init__(self, region_id, auth_addr, rw_permission, user_permission, permission_rule_priority, permission_rule_fuid=None, permission_rule_id=None):
        """
