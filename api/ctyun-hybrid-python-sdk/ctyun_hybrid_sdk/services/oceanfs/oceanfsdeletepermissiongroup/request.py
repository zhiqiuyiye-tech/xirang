...
class OceanfsDeletePermissionGroupRequest(CTYunRequest):
    """
    海量文件删除权限组
    """

    def __init__(self, request_param):
        super(OceanfsDeletePermissionGroupRequest, self).__init__("/v4/oceanfs/permission-group/delete-permission-group", "POST", "oceanfs", "application/json")
...
class OceanfsDeletePermissionGroupRequestParam(object):

    def __init__(self, region_id, permission_group_fuid=None, permission_group_id=None):
        """
