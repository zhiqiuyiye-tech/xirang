...
class OceanfsNewPermissionGroupRequest(CTYunRequest):
    """
    海量文件创建权限组
    """

    def __init__(self, request_param):
        super(OceanfsNewPermissionGroupRequest, self).__init__("/v4/oceanfs/permission-group/new-permission-group", "POST", "oceanfs", "application/json")
...
class OceanfsNewPermissionGroupRequestParam(object):
    ...
    def __init__(self, region_id, permission_group_name, network_type, permission_group_description=None):
        ...
        :param network_type: 权限组网络类型，仅支持 private_network
