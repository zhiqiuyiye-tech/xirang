...
class OceanfsListPermissionGroupRequest(CTYunRequest):
    """
    海量文件返回权限组描述信息
    """

    def __init__(self, request_param):
        super(OceanfsListPermissionGroupRequest, self).__init__("/v4/oceanfs/permission-group/list-permission-group", "GET", "oceanfs", "")
...
class OceanfsListPermissionGroupRequestParam(object):

    def __init__(self, region_id, page_no=None, page_size=None, permission_group_fuid=None, permission_group_id=None):
        """
        :param page_no: 页数。默认为1
        :param page_size: 每页个数。默认为10
