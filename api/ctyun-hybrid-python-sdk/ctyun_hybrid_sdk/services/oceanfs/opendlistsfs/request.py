...
class OpendListSfsRequest(CTYunRequest):
    """
    根据资源池 ID ，查询用户已开通文件系统
    """

    def __init__(self, request_param):
        super(OpendListSfsRequest, self).__init__("/v4/oceanfs/opend-list-sfs", "GET", "oceanfs", "")
...
class OpendListSfsRequestParam(object):
