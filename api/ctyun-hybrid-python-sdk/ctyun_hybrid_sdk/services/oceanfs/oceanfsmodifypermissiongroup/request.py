...
class OceanfsModifyPermissionGroupRequest(CTYunRequest):
    """
    海量文件修改权限组
    """

    def __init__(self, request_param):
        super(OceanfsModifyPermissionGroupRequest, self).__init__("/v4/oceanfs/permission-group/modify-permission-group", "POST", "oceanfs", "application/json")
...
class OceanfsModifyPermissionGroupRequestParam(object):

    def __init__(self, region_id, permission_group_fuid=None, permission_group_id=None, permission_group_name=None, permission_group_description=None):
        """
        ...
        :param permission_group_id: 权限组ID   
         permissionGroupFuid或permissionGroupID必传其中一个
        :param permission_group_name: 权限组名称
        :param permission_group_description: 描述信息
        """
