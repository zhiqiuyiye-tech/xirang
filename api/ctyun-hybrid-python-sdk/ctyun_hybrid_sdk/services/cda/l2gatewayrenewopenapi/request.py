...
class L2GatewayRenewOpenapiRequest(CTYunRequest):
    """
    企业交换机续订
    """

    def __init__(self, request_param):
        super(L2GatewayRenewOpenapiRequest, self).__init__("/v4/l2gw/renew", "POST", "cda", "application/json")
...
class L2GatewayRenewOpenapiRequestParam(object):

    def __init__(self, region_id, l2gw_id, cycle_type, cycle_count, client_token=None):
        """
        :param region_id: 资源池 ID
        :param client_token: 无实际意义
