...
class CloudvpnUserAddRequest(CTYunRequest):
    """
    客户信息增加
    """

    def __init__(self, request_param):
        super(CloudvpnUserAddRequest, self).__init__("/v4/cloudvpn/user/add", "POST", "cda", "application/json")
...
class CloudvpnUserAddRequestParam(object):
