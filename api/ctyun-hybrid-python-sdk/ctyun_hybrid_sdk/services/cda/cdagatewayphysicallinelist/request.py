...
class CdaGatewayPhysicalLineListRequest(CTYunRequest):
    """
    请求参数需要使用JSON格式
    """

    def __init__(self, request_param):
        super(CdaGatewayPhysicalLineListRequest, self).__init__("/v4/cda/gateway/physical-line-list", "GET", "cda", "")
...
class CdaGatewayPhysicalLineListRequestParam(object):

    def __init__(self, gateway_name, region_id, account=None):
        """
        :param gateway_name: 网关名称
        :param account: 公有云参数，混合云无实际意义
