...
class CdaBgpRouteAddRequest(CTYunRequest):
    """
     BGP路由添加
    """

    def __init__(self, request_param):
        super(CdaBgpRouteAddRequest, self).__init__("/v4/cda/bgp-route/add", "POST", "cda", "application/json")
...
class CdaBgpRouteAddRequestParam(object):

    def __init__(self, region_id, gateway_name, ip_version, multi_path_type=None, network_cidr=None, network_cidr_v6=None, bgp_list=None, bgp_ipv6_list=None, multi_path=None, multi_path_ipv6=None, multi_path_number=None, multi_path_num_ipv6=None):
        """
        :param region_id: 资源池id
        :param gateway_name: 专线网关名称
        :param multi_path_type: Bgp多路功能类型(IBGP/EBGP)   
        :param ip_version: IPV4 （默认)/DUALSTACK/IPV6
        :param network_cidr: 子网网段 ip和netmask之间用 / 分割(客户侧子网) 注意:此参数为数组
        :param network_cidr_v6: 子网网段 ip和netmask之间用 / 分割(客户侧子网v6) 注意:此参数为数组
        ...
        :param multi_path_num_ipv6: Bgp-ipv6多路功能条目
        """
    ...
    def set_network_cidr(self, network_cidr):
        """
        :param network_cidr: 子网网段 ip和netmask之间用 / 分割(客户侧子网)
        """
        self.network_cidr = network_cidr

    def set_network_cidr_v6(self, network_cidr_v6):
        """
        :param network_cidr_v6: 子网网段 ip和netmask之间用 / 分割(客户侧子网v6)
        """
        self.network_cidr_v6 = network_cidr_v6

    def set_bgp_list(self, bgp_list):
        """
        :param bgp_list: Ipv4类型的bgp
        """
        self.bgp_list = bgp_list

    def set_bgp_ipv6_list(self, bgp_ipv6_list):
        """
        :param bgp_ipv6_list: Ipv6类型的bgp
        """
        self.bgp_ipv6_list = bgp_ipv6_list
