...
class CdaPhysicalLineUnbindRequest(CTYunRequest):
    """
    专线网关解绑物理专线
    """

    def __init__(self, request_param):
        super(CdaPhysicalLineUnbindRequest, self).__init__("/v4/cda/physical-line/unbind", "POST", "cda", "application/json")
...
class CdaPhysicalLineUnbindRequestParam(object):

    def __init__(self, region_id, gateway_name, line_id, ):
        """
