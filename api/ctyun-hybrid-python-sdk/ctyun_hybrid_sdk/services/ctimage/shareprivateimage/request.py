...
class SharePrivateImageRequest(CTYunRequest):
    """
    公有云文档是传共享镜像的接受人的名称，混合云只支持共享镜像的接受项目的id
    """

    def __init__(self, request_param):
        super(SharePrivateImageRequest, self).__init__("/v4/image/shared-image/create", "POST", "ctimage", "application/json")
