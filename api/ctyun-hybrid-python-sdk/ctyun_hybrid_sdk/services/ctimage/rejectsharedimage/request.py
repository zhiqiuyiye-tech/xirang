...
class RejectSharedImageRequest(CTYunRequest):
    """
    无operationId
    """

    def __init__(self, request_param):
        super(RejectSharedImageRequest, self).__init__("/v4/image/shared-image/reject", "POST", "ctimage", "application/json")
...
class RejectSharedImageRequestParam(object):
    ...
    def __init__(self, region_id, image_id, az_name=None, destination_project_id=None):
        ...
        :param destination_project_id: 共享镜像的接受项目id, 混合云只支持项目维度
        """
