...
class InstanceAttachedVolumeIdListRequest(CTYunRequest):
    """
    根据实例ID查询对应挂载卷ID 
    """

    def __init__(self, request_param):
        super(InstanceAttachedVolumeIdListRequest, self).__init__("/v4/ebm/instance-attached-volume-id-list", "GET", "ebm", "")
...
class InstanceAttachedVolumeIdListRequestParam(object):

    def __init__(self, region_id, instance_uuid, az_name=None):
        """
        :param region_id: 区域ID
        :param az_name: 可用区
        :param instance_uuid: 主机实例ID
        """
