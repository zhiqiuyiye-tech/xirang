...
class RebootInstancesRequest(CTYunRequest):
    """
    只有在running状态下才能重启，否则报错
    """

    def __init__(self, request_param):
        super(RebootInstancesRequest, self).__init__("/v4/ebm/reboot", "POST", "ebm", "application/json")
...
class RebootInstancesRequestParam(object):

    def __init__(self, region_id, instance_uuid, az_name=None):
        """
        :param region_id: 区域ID
        :param az_name: 混合云非必填
