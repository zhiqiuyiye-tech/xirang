...
class AttachEbmVolumeRequest(CTYunRequest):
    """
    物理机挂载卷：   
    1. 裸金属的底层设备类型必须支持云硬盘   
    2. 如果是3.0资源池，则必须先关机   
    ...
    def __init__(self, request_param):
        super(AttachEbmVolumeRequest, self).__init__("/v4/ebm/attach-volume", "POST", "ebm", "application/json")
...
class AttachEbmVolumeRequestParam(object):
