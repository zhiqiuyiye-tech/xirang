...
class DescribeBmsInstanceRequest(CTYunRequest):
    """
    通过参数查询单台物理机信息。混合云返回字段publicIpv6，privateIPv6,vipUUIDList,vipList未对齐
    """

    def __init__(self, request_param):
        super(DescribeBmsInstanceRequest, self).__init__("/v4/ebm/describe", "GET", "ebm", "")
...
class DescribeBmsInstanceRequestParam(object):

    def __init__(self, region_id, instance_uuid, ):
        """
