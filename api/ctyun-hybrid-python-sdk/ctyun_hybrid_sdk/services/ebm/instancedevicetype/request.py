...
class InstanceDeviceTypeRequest(CTYunRequest):
    """
    根据实例ID查询对应套餐信息
    """

    def __init__(self, request_param):
        super(InstanceDeviceTypeRequest, self).__init__("/v4/ebm/instance-device-type", "GET", "ebm", "")
...
class InstanceDeviceTypeRequestParam(object):
