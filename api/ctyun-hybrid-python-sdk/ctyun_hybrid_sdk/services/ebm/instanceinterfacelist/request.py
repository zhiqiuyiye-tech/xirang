...
class InstanceInterfaceListRequest(CTYunRequest):
    """
    根据物理机实例UUID查询网卡信息列表。
    """

    def __init__(self, request_param):
        super(InstanceInterfaceListRequest, self).__init__("/v4/ebm/instance-interface-list", "GET", "ebm", "")
...
class InstanceInterfaceListRequestParam(object):

    def __init__(self, region_id, az_name, instance_uuid, ):
        """
        :param region_id: 区域ID
        :param az_name: 可用区  对应于云管平台的azID
