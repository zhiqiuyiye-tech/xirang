...
class RunInstancesRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(RunInstancesRequest, self).__init__("/v4/ebm/create", "POST", "ebm", "application/json")
...
class Disk(object):
    ...
    def __init__(self, disk_type, type, size, disk_mode=None, title=None, dss_cluster_id=None, dss_pool_id=None, pool_id=None):
        """
...
class RunInstancesRequestParam(object):

    def __init__(self, client_token, region_id, device_type, name, hostname, image_uuid, password, vpc_id, ext_ip, network_card_list, cycle_type, az_name=None, system_volume_raid_uuid=None, data_volume_raid_uuid=None, ip_type=None, bandwidth=None, ipv6_address=None, public_ip=None, security_group_id=None, disk_list=None, mtu=None, instance_charge_type=None, cycle_count=None, order_count=None, project_id=None):
        """
        :param client_token: （混合云可以不填）用于保证订单幂等性。要求单个云平台账户内唯一，使用同一个ClientToken值，其他请求参数相同时，则代表为同一个请求。保留时间为24小时
        :param region_id: 区域ID  
        :param az_name: 可用区
        :param device_type: 物理机套餐类型
        :param name: 物理机名称，长度为2-31位
        ...
        :param ip_type: 弹性IP版本 ，取值范围:[ipv4=v4地址,ipv6=v6地址]，默认值:ipv4--未对齐，只支持ipv4
        :param bandwidth: 带宽 ，取值范围:[1~2000]，默认值:100----extIP 为1时需要
        :param ipv6_address: ipv6地址--暂不支持
