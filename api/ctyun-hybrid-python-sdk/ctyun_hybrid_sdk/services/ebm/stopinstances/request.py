...
class StopInstancesRequest(CTYunRequest):
    """
    物理机关机
    """

    def __init__(self, request_param):
        super(StopInstancesRequest, self).__init__("/v4/ebm/power-off", "POST", "ebm", "application/json")
...
class StopInstancesRequestParam(object):

    def __init__(self, region_id, instance_uuid, az_name=None, client_token=None):
        """
