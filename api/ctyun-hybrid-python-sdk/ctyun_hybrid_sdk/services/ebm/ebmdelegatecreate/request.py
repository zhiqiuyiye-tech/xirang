...
class EbmDelegateCreateRequest(CTYunRequest):
    """
    接口约束：使用限制，本接口只支持在开启资源委托的4.0资源池使用
    """

    def __init__(self, request_param):
        super(EbmDelegateCreateRequest, self).__init__("/v4/ebm/delegate/create", "POST", "ebm", "application/json")
...
class EbmDelegateCreateRequestParam(object):
