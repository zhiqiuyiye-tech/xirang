...
class DssClusterRemovePoolRequest(CTYunRequest):
    """
    添加存储池到块存储专属集群
    """

    def __init__(self, request_param):
        super(DssClusterRemovePoolRequest, self).__init__("/v4/dss/remove-pool", "POST", "dss", "application/json")
...
class DssClusterRemovePoolRequestParam(object):
