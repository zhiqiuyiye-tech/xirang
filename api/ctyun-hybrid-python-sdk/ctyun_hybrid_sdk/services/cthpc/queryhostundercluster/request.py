...
class QueryHostUnderClusterRequest(CTYunRequest):
    """
    查询集群下的宿主机列表
    """

    def __init__(self, request_param):
        super(QueryHostUnderClusterRequest, self).__init__("/v4/cthpc/list-host", "GET", "cthpc", "")
...
class QueryHostUnderClusterRequestParam(object):

    def __init__(self, region_id, cluster_uuid, page_no=None, page_size=None, host_uuid=None, host_name=None, az_name=None, query_content=None):
        """
        :param page_no: 页码，默认值:1，超过50按50处理
        :param page_size: 每页记录数目，默认值:10，超过100按100处理
        :param region_id: 资源池ID
        :param cluster_uuid: 节点所属集群UUID
        :param host_uuid: 宿主机ID，精确搜索
        :param host_name: 宿主机名称，精确搜索
        :param az_name: 可用区 4.0必传
        :param query_content: 模糊搜索hostUUID或hostName
        """
