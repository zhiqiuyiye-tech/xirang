...
class EbsResizeRequest(CTYunRequest):
    """
    云硬盘修改规格 (云硬盘升级-工单流程)
    """

    def __init__(self, request_param):
        super(EbsResizeRequest, self).__init__("/v4/ebs/resize", "POST", "ebs", "application/json")
...
class EbsResizeRequestParam(object):

    def __init__(self, disk_size, client_token=None, region_id=None, resource_id=None, disk_id=None):
        """
        ...
        :param disk_size: 磁盘大小，单位GB,10-32768
        """
