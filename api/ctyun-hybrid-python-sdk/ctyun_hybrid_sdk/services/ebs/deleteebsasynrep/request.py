...
class DeleteEbsAsynRepRequest(CTYunRequest):
    """
    底层暂不支持
    """

    def __init__(self, request_param):
        super(DeleteEbsAsynRepRequest, self).__init__("/v4/async_rep/delete", "POST", "ebs", "application/json")
...
class DeleteEbsAsynRepRequestParam(object):
