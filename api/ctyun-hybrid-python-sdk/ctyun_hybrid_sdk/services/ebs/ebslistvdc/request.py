...
class EbsListVdcRequest(CTYunRequest):
    """
    云硬盘信息列表-vdc   
    ...
    def __init__(self, request_param):
        super(EbsListVdcRequest, self).__init__("/v4/ebs/list-vdc", "GET", "ebs", "")
...
class EbsListVdcRequestParam(object):

    def __init__(self, region_id, page_no=None, page_size=None, resource_id=None, org_id=None):
        """
        :param region_id: 资源池id
        :param page_no: 页码，默认值1
        :param page_size: 页大小，默认值10，可选范围1-100，大于100取100，不传、传0取10
