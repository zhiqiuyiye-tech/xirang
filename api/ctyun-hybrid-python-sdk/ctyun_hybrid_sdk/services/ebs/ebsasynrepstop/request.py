...
class EbsAsynRepStopRequest(CTYunRequest):
    """
    停止异步复制pair对复制，底层暂不支持
    """

    def __init__(self, request_param):
        super(EbsAsynRepStopRequest, self).__init__("/v4/async_rep/stop", "POST", "ebs", "application/json")
...
class EbsAsynRepStopRequestParam(object):
