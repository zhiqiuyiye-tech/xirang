...
class CreateEbsSnapRequest(CTYunRequest):
    """
    开发未对齐原因：混合云直接创建，公有云走工单创建
    """

    def __init__(self, request_param):
        super(CreateEbsSnapRequest, self).__init__("/v4/ebs_snapshot/create-ebs-snap", "POST", "ebs", "application/json")
...
class CreateEbsSnapRequestParam(object):

    def __init__(self, region_id, snapshot_name, disk_id, retention_policy=None, retention_time=None, client_token=None):
        """
        :param region_id: 区域ID
        :param snapshot_name: 快照名称仅允许英文字母数字及_或者-, 且长度为2-63字符
        :param disk_id: 云硬盘ID
