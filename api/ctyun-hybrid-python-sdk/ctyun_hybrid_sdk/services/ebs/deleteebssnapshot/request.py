...
class DeleteEbsSnapshotRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(DeleteEbsSnapshotRequest, self).__init__("/v4/ebs_snapshot/delete", "POST", "ebs", "application/json")
...
class DeleteEbsSnapshotRequestParam(object):

    def __init__(self, region_id, snapshot_ids, volume_id, refund_order=None):
        """
