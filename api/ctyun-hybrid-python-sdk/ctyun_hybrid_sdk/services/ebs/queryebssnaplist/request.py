...
class QueryEbsSnapListRequest(CTYunRequest):
    """
    查询云硬盘快照列表
    """

    def __init__(self, request_param):
        super(QueryEbsSnapListRequest, self).__init__("/v4/ebs_snapshot/list-ebs-snap", "GET", "ebs", "")
...
class QueryEbsSnapListRequestParam(object):

    def __init__(self, region_id, disk_id=None, snapshot_id=None, snapshot_name=None):
        """
        :param region_id: 资源池ID，请根据查询资源池列表接口返回值进行传参，获取“regionId”参数
        :param disk_id: 云硬盘ID
