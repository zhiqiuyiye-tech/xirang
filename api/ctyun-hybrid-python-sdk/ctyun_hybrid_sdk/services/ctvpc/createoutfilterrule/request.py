...
class CreateOutFilterRuleRequest(CTYunRequest):
    """
    destPort与srcPort 起始端口必须小于结束端口 当协议为ALL/ICMP时，端口传'-'
    """

    def __init__(self, request_param):
        super(CreateOutFilterRuleRequest, self).__init__("/v4/mirrorflow/create-filter-out-rule", "POST", "ctvpc", "application/json")
...
class CreateOutFilterRuleRequestParam(object):
