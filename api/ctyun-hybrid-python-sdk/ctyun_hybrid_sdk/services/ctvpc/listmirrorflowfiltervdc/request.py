...
class ListMirrorFlowFilterVdcRequest(CTYunRequest):
    """
    流量镜像过滤条件列表 Vdc
    """

    def __init__(self, request_param):
        super(ListMirrorFlowFilterVdcRequest, self).__init__("/v4/mirrorflow/list-filter-vdc", "GET", "ctvpc", "")
...
class ListMirrorFlowFilterVdcRequestParam(object):

    def __init__(self, region_id, query_content=None, page_no=None, page_size=None, org_id=None):
        """
