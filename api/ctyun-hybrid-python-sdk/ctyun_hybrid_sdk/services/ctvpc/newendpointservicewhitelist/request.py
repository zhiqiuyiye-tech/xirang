...
class NewEndpointServiceWhiteListRequest(CTYunRequest):
    """
    查询终端节点服务白名单
    """

    def __init__(self, request_param):
        super(NewEndpointServiceWhiteListRequest, self).__init__("/v4/vpce/new-list-endpoint-service-whitelist", "GET", "ctvpc", "")
...
class NewEndpointServiceWhiteListRequestParam(object):
