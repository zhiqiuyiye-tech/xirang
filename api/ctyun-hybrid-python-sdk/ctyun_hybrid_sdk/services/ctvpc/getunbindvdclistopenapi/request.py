...
class GetUnbindVdcListOpenApiRequest(CTYunRequest):
    """
    查询可绑定的VDC列表
    """

    def __init__(self, request_param):
        super(GetUnbindVdcListOpenApiRequest, self).__init__("/v4/eipPool/unbindVdcList", "GET", "ctvpc", "")
...
class GetUnbindVdcListOpenApiRequestParam(object):
