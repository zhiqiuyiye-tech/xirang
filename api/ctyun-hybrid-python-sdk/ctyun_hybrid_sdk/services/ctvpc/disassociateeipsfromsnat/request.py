...
class DisassociateEipsFromSnatRequest(CTYunRequest):
    """
    SNAT移除EIP
    """

    def __init__(self, request_param):
        super(DisassociateEipsFromSnatRequest, self).__init__("/v4/vpc/revoke-snat-for-eips", "POST", "ctvpc", "application/json")
