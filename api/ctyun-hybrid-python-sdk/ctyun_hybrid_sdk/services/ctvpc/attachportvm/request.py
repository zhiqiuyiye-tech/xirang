...
class AttachPortVmRequest(CTYunRequest):
    """
    EIP绑定云主机网卡
    """

    def __init__(self, request_param):
        super(AttachPortVmRequest, self).__init__("/v4/eip/attach-port-vm", "POST", "ctvpc", "application/json")
...
class AttachPortVmRequestParam(object):

    def __init__(self, region_id, port_id, eip_id, source_id, client_token=None, az_name=None, project_id=None):
        """
        :param region_id: 资源池 ID
        :param port_id: 云主机的网卡ID
        :param eip_id: 弹性ip 的 ID
        :param source_id: 云主机 的 ID
        :param client_token: 客户端存根，用于保证订单幂等性。要求单个云平台账户内唯一（非必填，并且此字段在私有云不具有实际意义）
        :param az_name: 可用区名称（V2该参数无意义）
