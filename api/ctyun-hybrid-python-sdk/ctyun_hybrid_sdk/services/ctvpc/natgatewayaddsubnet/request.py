...
class NatGatewayAddSubnetRequest(CTYunRequest):
    """
    修改NAT网关
    """

    def __init__(self, request_param):
        super(NatGatewayAddSubnetRequest, self).__init__("/v4/vpc/nat-gateway-add-subnet", "POST", "ctvpc", "application/json")
...
class NatGatewayAddSubnetRequestParam(object):

    def __init__(self, region_id, nat_gateway_id, subnet_id, ):
        """
        :param region_id: 资源池id
        :param nat_gateway_id: NAT网关ID
        :param subnet_id: 所绑定的子网ID
        """
