...
class ListAclRequest(CTYunRequest):
    """
    查询acl列表
    """

    def __init__(self, request_param):
        super(ListAclRequest, self).__init__("/v4/acl/list", "GET", "ctvpc", "")
...
class ListAclRequestParam(object):

    def __init__(self, region_id, acl_id=None, name=None, page_number=None, page_size=None, project_id=None):
        """
