...
class NewEndpointServicesListRequest(CTYunRequest):
    """
    查看终端节点服务列表
    """

    def __init__(self, request_param):
        super(NewEndpointServicesListRequest, self).__init__("/v4/vpce/new-list-endpoint-service", "GET", "ctvpc", "")
...
class NewEndpointServicesListRequestParam(object):

    def __init__(self, region_id, page=None, page_size=None, id=None, endpoint_service_name=None, query_content=None):
        """
