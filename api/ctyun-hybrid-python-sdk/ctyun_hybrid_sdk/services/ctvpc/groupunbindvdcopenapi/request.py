...
class GroupUnbindVdcOpenApiRequest(CTYunRequest):
    """
    ip地址组解绑vdc
    """

    def __init__(self, request_param):
        super(GroupUnbindVdcOpenApiRequest, self).__init__("/v4/eipPool/unbindVdc", "PUT", "ctvpc", "application/json")
...
class GroupUnbindVdcOpenApiRequestParam(object):

    def __init__(self, eip_address_group_id, vdc_id, ):
        """
