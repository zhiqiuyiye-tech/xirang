...
class V4VpcHavipBindForPassRequest(CTYunRequest):
    """
    v2绑定为同步操作，绑定成功为done的状态，若异常会直接报错
    """

    def __init__(self, request_param):
        super(V4VpcHavipBindForPassRequest, self).__init__("/v4/vpc/havip/bind-for-pass", "POST", "ctvpc", "application/json")
...
class V4VpcHavipBindForPassRequestParam(object):

    def __init__(self, region_id, ha_vip_id, resource_type, instance_id=None, az_name=None, network_interface_id=None, client_token=None, floating_id=None):
        """
        :param region_id: 区域ID
        :param ha_vip_id: VIP ID
        :param instance_id: ECS实例ID，当 resourceType 为 VM / PM 时，必填
        :param az_name: 可用区名称（非必填，3.0资源池该参数无意义）
        :param resource_type: 绑定实例类型
        :param network_interface_id: 网卡ID,当 resourceType 为 VM / PM 时，必填
