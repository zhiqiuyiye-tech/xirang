...
class DeleteSubnetRequest(CTYunRequest):
    """
    删除子网   
    ## 接口约束   
    ...
    def __init__(self, request_param):
        super(DeleteSubnetRequest, self).__init__("/v4/vpc/delete-subnet", "POST", "ctvpc", "application/json")
...
class DeleteSubnetRequestParam(object):
