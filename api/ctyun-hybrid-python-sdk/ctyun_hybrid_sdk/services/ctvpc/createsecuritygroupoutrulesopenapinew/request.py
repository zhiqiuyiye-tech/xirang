...
class CreateSecurityGroupOutRulesOpenapiNewRequest(CTYunRequest):
    """
    创建安全组出向规则。
    """

    def __init__(self, request_param):
        super(CreateSecurityGroupOutRulesOpenapiNewRequest, self).__init__("/v4/vpc/create-security-group-egress-new", "POST", "ctvpc", "application/json")
...
class SecurityGroupRule(object):
    ...
    def __init__(self, direction, ethertype, action, protocol, description=None, priority=None, range=None, dest_cidr_ip=None, remote_type=None, remote_security_group_id=None):
        """
        :param description: 安全组规则描述信息 支持拉丁字母、中文、数字, 特殊字符：\\~!@#$%^&*()_-+= <>?:"{},./;'[]·~！@#￥%……&*（） —— -+={}|《》？：“”【】、；‘'，。、，不能以 http: / https: 开头，长度 0 - 128
        :param direction: 方向egress
...
class CreateSecurityGroupOutRulesOpenapiNewRequestParam(object):
