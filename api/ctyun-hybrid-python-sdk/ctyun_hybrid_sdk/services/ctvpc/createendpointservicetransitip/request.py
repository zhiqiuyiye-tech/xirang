...
class CreateEndpointServiceTransitIPRequest(CTYunRequest):
    """
    创建节点服务中转ip
    """

    def __init__(self, request_param):
        super(CreateEndpointServiceTransitIPRequest, self).__init__("/v4/vpce/create-endpoint-service-transit-ip", "POST", "ctvpc", "application/json")
...
class CreateEndpointServiceTransitIPRequestParam(object):

    def __init__(self, region_id, endpoint_service_id, subnet_id, client_token=None, transit_ip=None):
        """
        :param client_token: 客户端存根，用于保证订单幂等性。要求单个云平台账户内唯一
        :param region_id: 资源池ID
        :param endpoint_service_id: 终端节点关联的终端节点服务
        :param subnet_id: 子网id
        :param transit_ip: 中转ip地址,acs类型资源池不支持指定
        """
    ...
    def set_transit_ip(self, transit_ip):
        """
        :param transit_ip: 中转ip地址,acs类型资源池不支持指定
        """
        self.transit_ip = transit_ip
