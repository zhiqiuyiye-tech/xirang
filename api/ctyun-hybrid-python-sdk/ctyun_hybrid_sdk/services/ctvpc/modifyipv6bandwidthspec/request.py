...
class ModifyIPv6BandwidthSpecRequest(CTYunRequest):
    """
    修改ipv6带宽规格
    """

    def __init__(self, request_param):
        super(ModifyIPv6BandwidthSpecRequest, self).__init__("/v4/ipv6_bandwidth/modify-spec", "POST", "ctvpc", "application/json")
...
class ModifyIPv6BandwidthSpecRequestParam(object):

    def __init__(self, region_id, bandwidth_id, bandwidth, client_token=None):
        """
        :param region_id: 资源池id
        :param bandwidth_id: 带宽id 
        :param bandwidth: 增加的带宽大小，峰值带宽上限默认最大上限值是3000，若云管配置中心设置的带宽上限值大于3000，则以云管设置的参数上限为准
        :param client_token: 客户端存根，用于保证订单幂等性（不传不校验）
        """
