...
class SgBatchDetachPortsRequest(CTYunRequest):
    """
    安全组批量解绑网卡。clientToken公有云必填字段，字段不影响接口功能，混合云不必填当作对齐。
    """

    def __init__(self, request_param):
        super(SgBatchDetachPortsRequest, self).__init__("/v4/vpc/batch-detach-security-group-ports", "POST", "ctvpc", "application/json")
...
class SgBatchDetachPortsRequestParam(object):
    ...
    def __init__(self, region_id, security_group_id, port_ids, client_token=None):
        ...
        :param client_token: 客户端（非必填，并且此字段在私有云不具有实际意义）
        """
