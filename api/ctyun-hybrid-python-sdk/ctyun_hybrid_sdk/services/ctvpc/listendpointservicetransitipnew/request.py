...
class ListEndpointServiceTransitIPNewRequest(CTYunRequest):
    """
    终端节点服务中转IP列表
    """

    def __init__(self, request_param):
        super(ListEndpointServiceTransitIPNewRequest, self).__init__("/v4/vpce/list-endpoint-service-transit-ip-new", "GET", "ctvpc", "")
...
class ListEndpointServiceTransitIPNewRequestParam(object):
