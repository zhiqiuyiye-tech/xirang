...
class RevokeSgIngressRuleRequest(CTYunRequest):
    """
    删除一条出方向安全组规则，撤销安全组出方向的权限设置。公有云入参缺clientToken字段，必填。暂不修改
    """

    def __init__(self, request_param):
        super(RevokeSgIngressRuleRequest, self).__init__("/v4/vpc/revoke-security-group-egress", "POST", "ctvpc", "application/json")
...
class RevokeSgIngressRuleRequestParam(object):
