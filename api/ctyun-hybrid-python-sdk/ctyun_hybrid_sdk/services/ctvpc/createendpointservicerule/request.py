...
class CreateEndpointServiceRuleRequest(CTYunRequest):
    """
    终端节点服务规则创建接口
    """

    def __init__(self, request_param):
        super(CreateEndpointServiceRuleRequest, self).__init__("/v4/vpce/create-endpoint-service-rule", "POST", "ctvpc", "application/json")
...
class CreateEndpointServiceRuleRequestParam(object):
