...
class DisassociateEipFromBandwidthRequest(CTYunRequest):
    """
    调用此接口可从共享带宽移出EIPs。
    """

    def __init__(self, request_param):
        super(DisassociateEipFromBandwidthRequest, self).__init__("/v4/bandwidth/disassociate-eip", "POST", "ctvpc", "application/json")
...
class DisassociateEipFromBandwidthRequestParam(object):

    def __init__(self, region_id, bandwidth_id, eip_ids, client_token=None):
        """
        :param region_id: 资源池id
        :param bandwidth_id: 共享带宽id
        :param eip_ids: 解绑Ipv4地址时：传弹性ip id列表 注意:此参数为数组
