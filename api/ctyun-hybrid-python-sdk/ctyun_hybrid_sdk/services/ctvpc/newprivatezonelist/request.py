...
class NewPrivateZoneListRequest(CTYunRequest):
    """
    内网 DNS 列表
    """

    def __init__(self, request_param):
        super(NewPrivateZoneListRequest, self).__init__("/v4/private-zone/new-list", "GET", "ctvpc", "")
...
class NewPrivateZoneListRequestParam(object):
