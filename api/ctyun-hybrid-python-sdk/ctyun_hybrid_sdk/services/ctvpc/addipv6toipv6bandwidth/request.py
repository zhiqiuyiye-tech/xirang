...
class AddIPv6ToIPv6BandwidthRequest(CTYunRequest):
    """
    IPv6带宽添加IPv6地址
    """

    def __init__(self, request_param):
        super(AddIPv6ToIPv6BandwidthRequest, self).__init__("/v4/ipv6_bandwidth/add-ipv6", "POST", "ctvpc", "application/json")
...
class AddIPv6ToIPv6BandwidthRequestParam(object):
