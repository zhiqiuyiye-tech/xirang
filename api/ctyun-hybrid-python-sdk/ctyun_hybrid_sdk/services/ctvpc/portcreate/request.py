...
class PortCreateRequest(CTYunRequest):
    ...
    def __init__(self, request_param):
        super(PortCreateRequest, self).__init__("/v4/ports/create", "POST", "ctvpc", "application/json")
...
class PortCreateRequestParam(object):
    ...
    def __init__(self, region_id, subnet_id, name=None, description=None, primary_private_ip=None, ipv6_addresses=None, secondary_private_ip_count=None, secondary_private_ips=None, security_group_ids=None, client_token=None, mtu=None):
        """
        :param region_id: 资源池id
        :param subnet_id: 子网id
        :param name: 名称，非空的情况下校验，支持拉丁字母、中文、数字，下划线，连字符，中文/英文字母开头，不能以http:/https:开头，长度2-32
        ...
        :param secondary_private_ip_count: 第二个IP数量，secondaryPrivateIps与secondaryPrivateIpCount只能传一个值，建议不超过15
        :param secondary_private_ips: 第二个IPs ，ip address为subnet内空闲ip，传列表，支持多个ip地址，建议不超过15个 注意:此参数为数组
        :param security_group_ids: 安全组ID，传列表，支持多个id。为空时使用vpc默认安全组 注意:此参数为数组
        :param client_token: 可传但是不进行校验，公有云需要暂无功能（非必填，并且此字段在私有云不具有实际意义）
        :param mtu: 网卡mtu，1500-8000，传0或者不传默认是1500，仅4.0资源池有效
        """
    ...
    def set_secondary_private_ips(self, secondary_private_ips):
        """
        :param secondary_private_ips: 第二个IPs ，ip address为subnet内空闲ip，传列表，支持多个ip地址，建议不超过15个
        """
        self.secondary_private_ips = secondary_private_ips

    def set_security_group_ids(self, security_group_ids):
        """
        :param security_group_ids: 安全组ID，传列表，支持多个id。为空时使用vpc默认安全组
        """
        self.security_group_ids = security_group_ids
