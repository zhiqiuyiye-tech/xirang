...
class CreateSnatEntryRequest(CTYunRequest):
    """
    创建SNAT规则。snatIps需填入弹性IP的ID
    """

    def __init__(self, request_param):
        super(CreateSnatEntryRequest, self).__init__("/v4/vpc/create-snat-entry", "POST", "ctvpc", "application/json")
...
class CreateSnatEntryRequestParam(object):

    def __init__(self, region_id, nat_gateway_id, snat_ips, source_subnet_id=None, description=None, source_cidr=None, client_token=None):
        """
        ...
        :param snat_ips: 弹性公网IP  的ID集合 注意:此参数为数组
