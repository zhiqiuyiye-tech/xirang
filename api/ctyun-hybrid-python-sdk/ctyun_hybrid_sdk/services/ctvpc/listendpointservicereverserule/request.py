...
class ListEndpointServiceReverseRuleRequest(CTYunRequest):
    """
    列表终端节点服务中转规则(反向访问规则)
    """

    def __init__(self, request_param):
        super(ListEndpointServiceReverseRuleRequest, self).__init__("/v4/vpce/list-endpoint-service-reverse-rule", "GET", "ctvpc", "")
...
class ListEndpointServiceReverseRuleRequestParam(object):

    def __init__(self, region_id, endpoint_service_id, page=None, page_size=None):
        """
        :param region_id: 资源池i的
        :param page: 页码，默认值1。不填/输入0，按照1查询
        :param page_size: 每页行数，范围1-100，不填/输入0，默认10查询，大于100按照100查询
        :param endpoint_service_id: 终端节点ID
        """
