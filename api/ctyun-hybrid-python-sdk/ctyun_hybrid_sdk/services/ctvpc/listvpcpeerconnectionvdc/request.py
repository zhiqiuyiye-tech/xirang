...
class ListVpcPeerConnectionVdcRequest(CTYunRequest):
    """
    查询对等连接列表
    """

    def __init__(self, request_param):
        super(ListVpcPeerConnectionVdcRequest, self).__init__("/v4/vpc/list-vpc-peer-connection-vdc", "GET", "ctvpc", "")
...
class ListVpcPeerConnectionVdcRequestParam(object):

    def __init__(self, region_id, page_size=None, page_number=None, page_no=None, org_id=None):
        """
