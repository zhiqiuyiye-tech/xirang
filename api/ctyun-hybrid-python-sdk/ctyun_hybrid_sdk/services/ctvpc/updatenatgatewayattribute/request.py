...
class UpdateNatGatewayAttributeRequest(CTYunRequest):
    """
    修改NAT网关
    """

    def __init__(self, request_param):
        super(UpdateNatGatewayAttributeRequest, self).__init__("/v4/vpc/modify-nat-gateway-attribute", "POST", "ctvpc", "application/json")
...
class UpdateNatGatewayAttributeRequestParam(object):

    def __init__(self, region_id, nat_gateway_id, name=None, description=None, client_token=None):
        """
