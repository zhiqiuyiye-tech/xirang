...
class ListBandwidthVdcRequest(CTYunRequest):
    """
    返回体中的creator已废弃勿用，值为空
    """

    def __init__(self, request_param):
        super(ListBandwidthVdcRequest, self).__init__("/v4/bandwidth/list-vdc", "GET", "ctvpc", "")
...
class ListBandwidthVdcRequestParam(object):

    def __init__(self, region_id, query_content=None, page_number=None, page_size=None, resource_id=None, org_id=None):
        """
