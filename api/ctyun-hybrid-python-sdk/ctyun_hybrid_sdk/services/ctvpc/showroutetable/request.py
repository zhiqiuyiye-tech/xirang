...
class ShowRouteTableRequest(CTYunRequest):
    """
    查询路由表详情
    """

    def __init__(self, request_param):
        super(ShowRouteTableRequest, self).__init__("/v4/vpc/route-table/show", "GET", "ctvpc", "")
...
class ShowRouteTableRequestParam(object):

    def __init__(self, region_id, route_table_id, ):
        """
