...
class ShowEndpointServiceConnectionsRequest(CTYunRequest):
    """
    终端节点服务连接查询
    """

    def __init__(self, request_param):
        super(ShowEndpointServiceConnectionsRequest, self).__init__("/v4/vpce/show-endpoint-service-connections", "GET", "ctvpc", "")
...
class ShowEndpointServiceConnectionsRequestParam(object):
