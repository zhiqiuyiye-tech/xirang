...
class NewPrivateZoneRecordListRequest(CTYunRequest):
    """
    内网 DNS 记录列表
    """

    def __init__(self, request_param):
        super(NewPrivateZoneRecordListRequest, self).__init__("/v4/private-zone-record/new-list", "GET", "ctvpc", "")
    ...
    def get_query_param(self):
        ...
        if self.parameters.zone_record_name is not None:
            query_param["zoneRecordName"] = self.parameters.zone_record_name
...
class NewPrivateZoneRecordListRequestParam(object):

    def __init__(self, region_id, zone_id=None, zone_record_id=None, zone_record_name=None, page_number=None, page_size=None, page_no=None):
        """
        :param region_id: 资源池id
        :param zone_id: 内网dns的id
        :param zone_record_id: 记录id
        :param zone_record_name: 记录集名字,V2.2.4.3版本新增
        ...
        self.zone_record_name = zone_record_name
    ...
    def set_zone_record_name(self, zone_record_name):
        """
        :param zone_record_name: 记录集名字,V2.2.4.3版本新增
        """
        self.zone_record_name = zone_record_name
