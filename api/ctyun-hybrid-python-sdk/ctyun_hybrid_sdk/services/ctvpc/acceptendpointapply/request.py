...
class AcceptEndpointApplyRequest(CTYunRequest):
    """
    通过终端节点连接申请
    """

    def __init__(self, request_param):
        super(AcceptEndpointApplyRequest, self).__init__("/v4/vpce/accept-endpoint-apply", "POST", "ctvpc", "application/json")
...
class AcceptEndpointApplyRequestParam(object):
