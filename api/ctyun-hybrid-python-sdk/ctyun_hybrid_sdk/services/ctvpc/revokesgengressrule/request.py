...
class RevokeSgEngressRuleRequest(CTYunRequest):
    """
    删除一条入方向安全组规则，撤销安全组出方向的权限设置。
    """

    def __init__(self, request_param):
        super(RevokeSgEngressRuleRequest, self).__init__("/v4/vpc/revoke-security-group-ingress", "POST", "ctvpc", "application/json")
...
class RevokeSgEngressRuleRequestParam(object):

    def __init__(self, region_id, security_group_id, security_group_rule_id, client_token=None):
        """
