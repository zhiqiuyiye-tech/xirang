...
class ListEndpointVdcRequest(CTYunRequest):
    """
    查看终端节点列表
    """

    def __init__(self, request_param):
        super(ListEndpointVdcRequest, self).__init__("/v4/vpce/list-endpoint-vdc", "GET", "ctvpc", "")
...
class ListEndpointVdcRequestParam(object):

    def __init__(self, region_id, page=None, page_size=None, endpoint_name=None, query_content=None, endpoint_id=None, org_id=None):
        """
