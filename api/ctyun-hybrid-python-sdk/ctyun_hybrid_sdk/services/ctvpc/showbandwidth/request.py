...
class ShowBandwidthRequest(CTYunRequest):
    """
    查询共享带宽详情
    """

    def __init__(self, request_param):
        super(ShowBandwidthRequest, self).__init__("/v4/bandwidth/describe", "GET", "ctvpc", "")
...
class ShowBandwidthRequestParam(object):

    def __init__(self, region_id, bandwidth_id, project_id=None):
        """
