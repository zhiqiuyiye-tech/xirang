...
class DeleteEndpointWhitelistRequest(CTYunRequest):
    """
    删除终端节点白名单
    """

    def __init__(self, request_param):
        super(DeleteEndpointWhitelistRequest, self).__init__("/v4/vpce/delete-endpoint-whitelist", "POST", "ctvpc", "application/json")
...
class DeleteEndpointWhitelistRequestParam(object):

    def __init__(self, region_id, endpoint_id, client_token, ):
        """
