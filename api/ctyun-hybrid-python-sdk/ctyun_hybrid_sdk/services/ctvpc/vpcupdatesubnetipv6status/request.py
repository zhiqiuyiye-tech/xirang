...
class VpcUpdateSubnetIpv6StatusRequest(CTYunRequest):
    """
    修改子网的 IPv6 状态；3.0 子网一旦开启 ipv6 就不能关闭了
    """

    def __init__(self, request_param):
        super(VpcUpdateSubnetIpv6StatusRequest, self).__init__("/v4/vpc/update-subnet-ipv6-status", "POST", "ctvpc", "application/json")
...
class VpcUpdateSubnetIpv6StatusRequestParam(object):

    def __init__(self, region_id, subnet_id, enable_ipv6, client_token=None, az_name=None, project_id=None):
        """
        ...
        :param az_name: 可用区名称（差异点说明：2.0此参数实际无意义）
