...
class BandwidthQueryRenewPriceRequest(CTYunRequest):
    """
    共享带宽续订询价
    """

    def __init__(self, request_param):
        super(BandwidthQueryRenewPriceRequest, self).__init__("/v4/bandwidth/query-renew-price", "POST", "ctvpc", "application/json")
...
class BandwidthQueryRenewPriceRequestParam(object):

    def __init__(self, region_id, bandwidth_id, cycle_type, cycle_count, project_id=None, client_token=None):
        """
        :param region_id: 共享带宽的区域id
        :param bandwidth_id: 共享带宽 ID
        :param cycle_type: 订购类型：month / year
        :param cycle_count: 订购时长, 当 cycleType = month, 支持续订 1 - 11 个月; 当 cycleType = year, 支持续订 1 - 3 年
