...
class ApiOrderRenewIpv6BandwidthRequest(CTYunRequest):
    """
    续订 IPv6 带宽
    """

    def __init__(self, request_param):
        super(ApiOrderRenewIpv6BandwidthRequest, self).__init__("/v4/ipv6_bandwidth/renew", "POST", "ctvpc", "application/json")
...
class ApiOrderRenewIpv6BandwidthRequestParam(object):

    def __init__(self, client_token, region_id, cycle_type, cycle_count, bandwidth_id, ):
        """
