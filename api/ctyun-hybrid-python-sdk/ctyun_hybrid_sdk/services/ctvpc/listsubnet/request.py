...
class ListSubnetRequest(CTYunRequest):
    """
    查询用户专有网络下子网列表
    """

    def __init__(self, request_param):
        super(ListSubnetRequest, self).__init__("/v4/vpc/list-subnet", "GET", "ctvpc", "")
...
class ListSubnetRequestParam(object):

    def __init__(self, region_id, vpc_id=None, subnet_id=None, az_name=None, page_number=None, page_size=None, client_token=None, project_id=None):
        """
        :param region_id: 
