...
class QuerySecurityGroupsVdcRequest(CTYunRequest):
    """
    查询用户安全组列表。
    """

    def __init__(self, request_param):
        super(QuerySecurityGroupsVdcRequest, self).__init__("/v4/vpc/query-security-groups-vdc", "GET", "ctvpc", "")
...
class QuerySecurityGroupsVdcRequestParam(object):

    def __init__(self, region_id, vpc_id=None, page_number=None, page_size=None, query_content=None, instance_id=None, org_id=None):
        """
