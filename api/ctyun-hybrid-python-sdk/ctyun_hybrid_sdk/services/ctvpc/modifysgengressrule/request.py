...
class ModifySgEngressRuleRequest(CTYunRequest):
    """
    修改安全组出方向规则的描述信息，该接口只能修改出方向描述信息。
    """

    def __init__(self, request_param):
        super(ModifySgEngressRuleRequest, self).__init__("/v4/vpc/modify-security-group-egress", "POST", "ctvpc", "application/json")
...
class ModifySgEngressRuleRequestParam(object):
