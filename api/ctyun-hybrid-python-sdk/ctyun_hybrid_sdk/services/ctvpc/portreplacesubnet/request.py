...
class PortReplaceSubnetRequest(CTYunRequest):
    """
    网卡更换子网和IP地址
    """

    def __init__(self, request_param):
        super(PortReplaceSubnetRequest, self).__init__("/v4/ports/change-private-ip", "POST", "ctvpc", "application/json")
...
class PortReplaceSubnetRequestParam(object):

    def __init__(self, region_id, network_interface_id, subnet_id, instance_id, ip_address=None):
        """
