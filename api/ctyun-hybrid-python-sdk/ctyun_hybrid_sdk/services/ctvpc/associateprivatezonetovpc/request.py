...
class AssociatePrivateZoneToVpcRequest(CTYunRequest):
    """
    内网 DNS 关联 VPC
    """

    def __init__(self, request_param):
        super(AssociatePrivateZoneToVpcRequest, self).__init__("/v4/private-zone/associate-vpc", "POST", "ctvpc", "application/json")
...
class AssociatePrivateZoneToVpcRequestParam(object):
