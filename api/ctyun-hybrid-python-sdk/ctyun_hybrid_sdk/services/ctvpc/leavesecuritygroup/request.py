...
class LeaveSecurityGroupRequest(CTYunRequest):
    """
    解绑安全组。当主机只有一个安全组绑定着的时候，该安全组不支持解绑
    """

    def __init__(self, request_param):
        super(LeaveSecurityGroupRequest, self).__init__("/v4/vpc/leave-security-group", "POST", "ctvpc", "application/json")
...
class LeaveSecurityGroupRequestParam(object):

    def __init__(self, region_id, security_group_id, instance_id, ):
        """
