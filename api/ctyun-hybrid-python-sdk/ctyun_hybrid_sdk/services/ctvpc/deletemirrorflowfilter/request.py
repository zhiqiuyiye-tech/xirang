...
class DeleteMirrorFlowFilterRequest(CTYunRequest):
    """
    流量镜像过滤条件删除
    """

    def __init__(self, request_param):
        super(DeleteMirrorFlowFilterRequest, self).__init__("/v4/mirrorflow/delete-filter", "POST", "ctvpc", "application/json")
...
class DeleteMirrorFlowFilterRequestParam(object):
