...
class DeleteBandwidthRequest(CTYunRequest):
    """
    删除共享带宽
    """

    def __init__(self, request_param):
        super(DeleteBandwidthRequest, self).__init__("/v4/bandwidth/delete", "POST", "ctvpc", "application/json")
...
class DeleteBandwidthRequestParam(object):
