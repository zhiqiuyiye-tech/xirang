...
class GetNewRouteRuleListOpenapiRequest(CTYunRequest):
    """
    新查询路由表规则列表   
    ...
    def __init__(self, request_param):
        super(GetNewRouteRuleListOpenapiRequest, self).__init__("/v4/vpc/route-table/new-list-rules", "GET", "ctvpc", "")
...
class GetNewRouteRuleListOpenapiRequestParam(object):

    def __init__(self, region_id, route_table_id, page_number=None, page_size=None, page_no=None):
        """
        :param region_id: 区域id
        :param route_table_id: 路由表 id
        :param page_number: 列表的页码，默认值为 1。最小值1
        :param page_size: 分页查询时每页的行数，最大值为 50，默认值为 10。最小值1
        :param page_no: 列表的页码，默认值为 1, 最小值1推荐使用该字段, pageNumber 后续会废弃 
        """
