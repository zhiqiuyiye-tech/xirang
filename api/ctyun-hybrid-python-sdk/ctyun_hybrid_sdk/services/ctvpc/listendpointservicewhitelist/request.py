...
class ListEndpointServiceWhitelistRequest(CTYunRequest):
    """
     查询终端节点服务白名单
    """

    def __init__(self, request_param):
        super(ListEndpointServiceWhitelistRequest, self).__init__("/v4/vpce/list-endpoint-service-whitelist", "GET", "ctvpc", "")
...
class ListEndpointServiceWhitelistRequestParam(object):
