...
class VpcListVdcRequest(CTYunRequest):
    """
    查询VPC列表
    """

    def __init__(self, request_param):
        super(VpcListVdcRequest, self).__init__("/v4/vpc/list-vdc", "GET", "ctvpc", "")
...
class VpcListVdcRequestParam(object):

    def __init__(self, region_id, page_number=None, page_size=None, vpc_id=None, ipv4_cidrs=None, org_id=None):
        """
        :param region_id: 
