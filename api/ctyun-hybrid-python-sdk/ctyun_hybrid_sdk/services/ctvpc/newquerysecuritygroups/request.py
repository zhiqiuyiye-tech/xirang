...
class NewQuerySecurityGroupsRequest(CTYunRequest):
    """
    查询用户安全组列表。
    """

    def __init__(self, request_param):
        super(NewQuerySecurityGroupsRequest, self).__init__("/v4/vpc/new-query-security-groups", "GET", "ctvpc", "")
...
class NewQuerySecurityGroupsRequestParam(object):
