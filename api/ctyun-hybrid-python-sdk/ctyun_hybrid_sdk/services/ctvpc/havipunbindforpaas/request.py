...
class HavipUnbindForPaasRequest(CTYunRequest):
    """
    v2绑定为同步操作，若异常会直接报错   
    ## 接口约束   
    ...
    def __init__(self, request_param):
        super(HavipUnbindForPaasRequest, self).__init__("/v4/vpc/havip/unbind-for-paas", "POST", "ctvpc", "application/json")
...
class HavipUnbindForPaasRequestParam(object):

    def __init__(self, region_id, resource_type, ha_vip_id, network_interface_id, client_token=None, instance_id=None, floating_id=None):
        """
        ...
        :param network_interface_id: 虚拟网卡ID
