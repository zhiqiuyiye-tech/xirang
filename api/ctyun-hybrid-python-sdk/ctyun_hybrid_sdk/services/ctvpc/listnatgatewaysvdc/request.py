...
class ListNatGatewaysVdcRequest(CTYunRequest):
    """
    查询NAT网关接口列表
    """

    def __init__(self, request_param):
        super(ListNatGatewaysVdcRequest, self).__init__("/v4/vpc/describe-nat-gateways-vdc", "GET", "ctvpc", "")
...
class ListNatGatewaysVdcRequestParam(object):

    def __init__(self, region_id, nat_gateway_id=None, page_number=None, page_no=None, page_size=None, org_id=None):
        """
