...
class CreateSgEgressRuleRequest(CTYunRequest):
    """
    创建安全组出向规则。
    """

    def __init__(self, request_param):
        super(CreateSgEgressRuleRequest, self).__init__("/v4/vpc/create-security-group-egress", "POST", "ctvpc", "application/json")
...
class SecurityGroupRule(object):
    ...
    def __init__(self, direction, ethertype, priority, action, protocol, description=None, range=None, dest_cidr_ip=None):
        """
...
class CreateSgEgressRuleRequestParam(object):
