...
class DeleteSnatEntryRequest(CTYunRequest):
    """
    删除SNAT规则
    """

    def __init__(self, request_param):
        super(DeleteSnatEntryRequest, self).__init__("/v4/vpc/delete-snat-entry", "POST", "ctvpc", "application/json")
...
class DeleteSnatEntryRequestParam(object):

    def __init__(self, region_id, s_nat_id, client_token=None):
        """
