...
class DeleteEipAddressGroupOpenApiRequest(CTYunRequest):
    """
    删除ip地址组
    """

    def __init__(self, request_param):
        super(DeleteEipAddressGroupOpenApiRequest, self).__init__("/v4/eipPool/delete", "POST", "ctvpc", "application/json")
...
class DeleteEipAddressGroupOpenApiRequestParam(object):

    def __init__(self, eip_address_group_id, ):
        """
        :param eip_address_group_id: 需要删除的EIP组ID
        """
