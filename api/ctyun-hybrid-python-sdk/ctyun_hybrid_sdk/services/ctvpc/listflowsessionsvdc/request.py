...
class ListFlowSessionsVdcRequest(CTYunRequest):
    """
    查看流量会话列表 Vdc
    """

    def __init__(self, request_param):
        super(ListFlowSessionsVdcRequest, self).__init__("/v4/flowsession/list-vdc", "GET", "ctvpc", "")
...
class ListFlowSessionsVdcRequestParam(object):

    def __init__(self, region_id, mirror_filter_id=None, query_content=None, page_number=None, page_size=None, org_id=None):
        """
        :param region_id: 区域ID
        :param mirror_filter_id: 筛选id
        :param query_content: 按名字进行模糊过滤
    ...
    def set_mirror_filter_id(self, mirror_filter_id):
        """
        :param mirror_filter_id: 筛选id
        """
        self.mirror_filter_id = mirror_filter_id
