...
class AssociateIPv6ToBandwidthRequest(CTYunRequest):
    """
    调用方式：   
    ...
    def __init__(self, request_param):
        super(AssociateIPv6ToBandwidthRequest, self).__init__("/v4/bandwidth/associate-ipv6", "POST", "ctvpc", "application/json")
...
class AssociateIPv6ToBandwidthRequestParam(object):
