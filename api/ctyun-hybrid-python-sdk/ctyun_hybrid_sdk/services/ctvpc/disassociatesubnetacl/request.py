...
class DisassociateSubnetAclRequest(CTYunRequest):
    """
    子网解绑ACL
    """

    def __init__(self, request_param):
        super(DisassociateSubnetAclRequest, self).__init__("/v4/vpc/disassociate-subnet-acl", "POST", "ctvpc", "application/json")
...
class DisassociateSubnetAclRequestParam(object):
