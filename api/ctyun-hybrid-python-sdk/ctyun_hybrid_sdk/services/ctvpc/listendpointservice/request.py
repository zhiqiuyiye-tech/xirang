...
class ListEndpointServiceRequest(CTYunRequest):
    """
    查看终端节点服务列表
    """

    def __init__(self, request_param):
        super(ListEndpointServiceRequest, self).__init__("/v4/vpce/list-endpoint-service", "GET", "ctvpc", "")
...
class ListEndpointServiceRequestParam(object):
