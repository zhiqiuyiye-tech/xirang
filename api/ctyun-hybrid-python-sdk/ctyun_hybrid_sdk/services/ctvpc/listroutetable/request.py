...
class ListRouteTableRequest(CTYunRequest):
    """
    查询路由表列表
    """

    def __init__(self, request_param):
        super(ListRouteTableRequest, self).__init__("/v4/vpc/route-table/list", "GET", "ctvpc", "")
...
class ListRouteTableRequestParam(object):

    def __init__(self, region_id, vpc_id=None, query_content=None, route_table_id=None, page_number=None, page_size=None):
        """
