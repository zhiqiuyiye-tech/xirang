...
class ShowSnatRequest(CTYunRequest):
    """
    获取SNAT规则详情
    """

    def __init__(self, request_param):
        super(ShowSnatRequest, self).__init__("/v4/vpc/show-snat", "GET", "ctvpc", "")
...
class ShowSnatRequestParam(object):

    def __init__(self, region_id, s_nat_id, ):
        """
