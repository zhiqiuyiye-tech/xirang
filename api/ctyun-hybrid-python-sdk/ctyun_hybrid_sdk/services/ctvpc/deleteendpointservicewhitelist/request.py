...
class DeleteEndpointServiceWhitelistRequest(CTYunRequest):
    """
    删除终端节点服务白名单
    """

    def __init__(self, request_param):
        super(DeleteEndpointServiceWhitelistRequest, self).__init__("/v4/vpce/delete-endpoint-service-whitelist", "POST", "ctvpc", "application/json")
...
class DeleteEndpointServiceWhitelistRequestParam(object):
