...
class NewEndpointsListRequest(CTYunRequest):
    """
    查看终端节点列表   
    ...
    def __init__(self, request_param):
        super(NewEndpointsListRequest, self).__init__("/v4/vpce/new-list-endpoint", "GET", "ctvpc", "")
...
class NewEndpointsListRequestParam(object):

    def __init__(self, region_id, page=None, page_size=None, endpoint_name=None, query_content=None, endpoint_id=None, endpoint_service_id=None, page_no=None):
        """
