...
class QueryRenewIpv6BandwidthPriceRequest(CTYunRequest):
    """
    续订询价。
    """

    def __init__(self, request_param):
        super(QueryRenewIpv6BandwidthPriceRequest, self).__init__("/v4/ipv6_bandwidth/query-renew-price", "POST", "ctvpc", "application/json")
...
class QueryRenewIpv6BandwidthPriceRequestParam(object):

    def __init__(self, region_id, cycle_type, cycle_count, bandwidth_id, client_token=None):
        """
