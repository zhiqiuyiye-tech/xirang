...
class OpenAPIDeleteLicenseRequest(CTYunRequest):
    """
    仅允许删除状态为无效和已过期的许可证
    """

    def __init__(self, request_param):
        super(OpenAPIDeleteLicenseRequest, self).__init__("/v4/license/delete", "POST", "licenseconfig", "application/json")
...
class OpenAPIDeleteLicenseRequestParam(object):
