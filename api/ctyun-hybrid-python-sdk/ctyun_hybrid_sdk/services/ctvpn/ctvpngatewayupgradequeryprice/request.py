...
class CtvpnGatewayUpgradeQueryPriceRequest(CTYunRequest):
    """
    VPN网关升配询价
    """

    def __init__(self, request_param):
        super(CtvpnGatewayUpgradeQueryPriceRequest, self).__init__("/v4/vpn/gateway/query-price-upgrade", "POST", "ctvpn", "application/json")
...
class CtvpnGatewayUpgradeQueryPriceRequestParam(object):

    def __init__(self, region_id, bandwidth, connection_limit, resource_id, client_token=None, link_resource_id=None):
        """
        :param client_token: 客户端存根，用于保证订单幂等性
        :param region_id: 资源池id
        :param bandwidth: 带宽大小
        :param connection_limit: VPN网关连接数限制
        :param link_resource_id: VPN连接资源ID，对齐公有云，无实际意义，传任意字符串
