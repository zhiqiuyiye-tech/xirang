...
class CtvpnGatewayRenewQueryPriceRequest(CTYunRequest):
    """
    VPN网关续订询价
    """

    def __init__(self, request_param):
        super(CtvpnGatewayRenewQueryPriceRequest, self).__init__("/v4/vpn/gateway/query-price-renew", "POST", "ctvpn", "application/json")
...
class CtvpnGatewayRenewQueryPriceRequestParam(object):
    ...
    def __init__(self, region_id, cycle_type, cycle_count, resource_id, client_token=None):
        ...
        :param cycle_count: 包周期数。周期最大长度不能超过36个月
        :param resource_id: VPN网关资源ID
        """
