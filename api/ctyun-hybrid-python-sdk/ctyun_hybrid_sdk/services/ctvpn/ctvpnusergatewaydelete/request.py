...
class CtvpnUserGatewayDeleteRequest(CTYunRequest):
    """
    用户网关删除
    """

    def __init__(self, request_param):
        super(CtvpnUserGatewayDeleteRequest, self).__init__("/v4/vpn/user-gateway/delete", "POST", "ctvpn", "application/json")
...
class CtvpnUserGatewayDeleteRequestParam(object):
