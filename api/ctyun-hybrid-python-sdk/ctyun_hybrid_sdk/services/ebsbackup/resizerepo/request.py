...
class ResizeRepoRequest(CTYunRequest):
    """
    扩容云硬盘备份存储库   
    ...
    def __init__(self, request_param):
        super(ResizeRepoRequest, self).__init__("/v4/ebs-backup/repo/resize", "POST", "ebsbackup", "application/json")
...
class ResizeRepoRequestParam(object):
    ...
    def __init__(self, region_id, repository_id, size, client_token=None):
        ...
        :param size: 扩容后容量不超过1024000,单位GB;扩容容量不小于存储库剩余容量的绝对值
        """
