...
class EbsBackupPolicyBindRepoRequest(CTYunRequest):
    """
    云盘备份策略绑定备份库
    """

    def __init__(self, request_param):
        super(EbsBackupPolicyBindRepoRequest, self).__init__("/v4/ebs-backup/policy/bind-repo", "POST", "ebsbackup", "application/json")
...
class EbsBackupPolicyBindRepoRequestParam(object):
