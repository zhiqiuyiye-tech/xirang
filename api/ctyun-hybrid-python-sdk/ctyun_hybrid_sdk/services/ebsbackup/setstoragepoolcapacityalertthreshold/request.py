...
class SetStoragePoolCapacityAlertThresholdRequest(CTYunRequest):
    """
    2.2.6新增
    """

    def __init__(self, request_param):
        super(SetStoragePoolCapacityAlertThresholdRequest, self).__init__("/v4/ebs-backup/repo/set-capacity-alert-threshold", "POST", "ebsbackup", "application/json")
...
class SetStoragePoolCapacityAlertThresholdRequestParam(object):
