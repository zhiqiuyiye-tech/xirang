...
class ListEbsBackupRepoRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(ListEbsBackupRepoRequest, self).__init__("/v4/ebs-backup/repo/list", "GET", "ebsbackup", "")
...
class ListEbsBackupRepoRequestParam(object):

    def __init__(self, region_id, repository_id=None, resource_id=None, repository_name=None, status=None, query_content=None, hide_expire=None, asc=None, sort=None, project_id=None):
        """
        :param region_id: 资源池id
        :param repository_id: 云硬盘备份存储库ID，支持模糊匹配
        :param resource_id: 兼容v1,该参数和repositoryID二选一,同时存在时以repositoryID优先
        :param repository_name: 云硬盘备份存储库名称，支持模糊匹配
        :param status: 云硬盘备份存储库状态:active-可用 expired-禁用（兼容v1 available-可用;unavailable-不可用）
        :param query_content: 模糊查询，筛选存储库名称或ID等于此参数值的存储库
        :param hide_expire: 是否隐藏过期的云硬盘备份库，true-隐藏，false-不隐藏
        :param asc: 和sort配合使用，是否升序排列,Boolean 类 true/false，默认为false
        :param sort: 和asc配合使用，指定用于排序的字段。可选字段：createdDate/expiredDate/size/freeSize/name，默认为createdDate
