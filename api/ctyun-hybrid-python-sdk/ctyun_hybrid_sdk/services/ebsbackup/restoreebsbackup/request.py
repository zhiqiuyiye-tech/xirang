...
class RestoreEbsBackupRequest(CTYunRequest):
    """
    开发未对齐原因：混合云返回异步任务ID，公有不返回
    """

    def __init__(self, request_param):
        super(RestoreEbsBackupRequest, self).__init__("/v4/ebs-backup/restore", "POST", "ebsbackup", "application/json")
...
class RestoreEbsBackupRequestParam(object):

    def __init__(self, region_id, volume_id, backup_id, ):
        """
