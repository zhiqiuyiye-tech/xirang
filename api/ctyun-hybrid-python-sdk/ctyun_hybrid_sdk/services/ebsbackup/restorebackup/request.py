...
class RestoreBackupRequest(CTYunRequest):
    """
    ...
    def __init__(self, request_param):
        super(RestoreBackupRequest, self).__init__("/v4/ebs-backup/restore-backup", "POST", "ebsbackup", "application/json")
...
class RestoreBackupRequestParam(object):
