...
class ListEbsBackupPolicyRequest(CTYunRequest):
    """
    参数返回和v1未对齐，v1返回列表为returnObj.results，v2实现对齐公有云使用returnObj.policyList
    """

    def __init__(self, request_param):
        super(ListEbsBackupPolicyRequest, self).__init__("/v4/ebs-backup/policy/list", "GET", "ebsbackup", "")
...
class ListEbsBackupPolicyRequestParam(object):
