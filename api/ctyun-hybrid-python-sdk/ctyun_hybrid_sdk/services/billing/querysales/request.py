...
class QuerySalesRequest(CTYunRequest):
    """
    获取销售品列表
    """

    def __init__(self, request_param):
        super(QuerySalesRequest, self).__init__("/v1/billing/querySales", "GET", "billing", "")
...
class QuerySalesRequestParam(object):

    def __init__(self, product_id, status=None, name=None, page=None, page_size=None):
        """
        :param product_id: 产品ID
        :param status: 销售品状态, 1-启用, 2-停用
