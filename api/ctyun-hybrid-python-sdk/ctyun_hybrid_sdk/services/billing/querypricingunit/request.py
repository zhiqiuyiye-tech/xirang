...
class QueryPricingUnitRequest(CTYunRequest):
    """
    获取产品计价单元
    """

    def __init__(self, request_param):
        super(QueryPricingUnitRequest, self).__init__("/v1/billing/queryPricingUnit", "GET", "billing", "")
...
class QueryPricingUnitRequestParam(object):

    def __init__(self, product_id, page=None, page_size=None):
        """
