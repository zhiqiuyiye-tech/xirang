...
class BillQryOnDemandBillDetailResDetailRequest(CTYunRequest):
    """
    50. 账单明细资源+明细(按需)
    """

    def __init__(self, request_param):
        super(BillQryOnDemandBillDetailResDetailRequest, self).__init__("/billQryOnDemandBillDetailResDetail", "POST", "billing", "application/json")
...
class BillQryOnDemandBillDetailResDetailRequestParam(object):

    def __init__(self, page_no, page_size, billing_cycle_id, resource_id=None, product_code=None, contract_id=None, has_total=None):
        """
        :param page_no: 页码
        :param page_size: 页数
