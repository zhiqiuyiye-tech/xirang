...
class QueryVdcDiscountsRequest(CTYunRequest):
    """
    获取VDC特价
    """

    def __init__(self, request_param):
        super(QueryVdcDiscountsRequest, self).__init__("/v1/billing/queryVdcDiscounts", "GET", "billing", "")
...
class QueryVdcDiscountsRequestParam(object):
