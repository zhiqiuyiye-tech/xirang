...
class QryOnDemandBillDetailProdCycleIdRequest(CTYunRequest):
    """
    51. 账单明细产品+账期（按需）
    """

    def __init__(self, request_param):
        super(QryOnDemandBillDetailProdCycleIdRequest, self).__init__("/qryOnDemandBillDetailProdCycleId", "POST", "billing", "application/json")
...
class QryOnDemandBillDetailProdCycleIdRequestParam(object):

    def __init__(self, page_no, page_size, billing_cycle_id, resource_id=None, product_code=None, contract_id=None, bill_type=None, has_total=None, group_byon_day=None):
        """
        :param page_no: 页码
        :param page_size: 页数
        ...
        :param group_byon_day: 1：按天 0或者为空：按账期查询 (混合云暂未接入)
        """
