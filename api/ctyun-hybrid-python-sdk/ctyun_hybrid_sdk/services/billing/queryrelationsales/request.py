...
class QueryRelationSalesRequest(CTYunRequest):
    """
    获取关联销售品列表
    """

    def __init__(self, request_param):
        super(QueryRelationSalesRequest, self).__init__("/v1/billing/queryRelationSales", "GET", "billing", "")
...
class QueryRelationSalesRequestParam(object):
