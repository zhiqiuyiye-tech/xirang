...
class PrivateNATApiListRequest(CTYunRequest):
    """
    查询私网NAT网关接口列表
    """

    def __init__(self, request_param):
        super(PrivateNATApiListRequest, self).__init__("/v4/privatenat/list", "GET", "ctnat", "")
...
class PrivateNATApiListRequestParam(object):

    def __init__(self, region_id, nat_gateway_id=None, page_number=None, page_no=None, page_size=None):
        """
        :param region_id: 资源池id
        :param nat_gateway_id: 私网NAT网关id
