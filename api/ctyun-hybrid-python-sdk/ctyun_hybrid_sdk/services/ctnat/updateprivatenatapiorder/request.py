...
class UpdatePrivateNATApiOrderRequest(CTYunRequest):
    """
    变配私网NAT网关
    """

    def __init__(self, request_param):
        super(UpdatePrivateNATApiOrderRequest, self).__init__("/v4/privatenat/modify-spec", "POST", "ctnat", "application/json")
...
class UpdatePrivateNATApiOrderRequestParam(object):
