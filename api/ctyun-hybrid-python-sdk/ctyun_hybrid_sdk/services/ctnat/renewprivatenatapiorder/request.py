...
class RenewPrivateNATApiOrderRequest(CTYunRequest):
    """
    续订NAT网关
    """

    def __init__(self, request_param):
        super(RenewPrivateNATApiOrderRequest, self).__init__("/v4/privatenat/renew-privatenat", "POST", "ctnat", "application/json")
...
class RenewPrivateNATApiOrderRequestParam(object):
