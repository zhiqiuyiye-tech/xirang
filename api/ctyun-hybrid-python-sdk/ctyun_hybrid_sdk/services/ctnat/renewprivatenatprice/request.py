...
class RenewPrivateNatPriceRequest(CTYunRequest):
    """
    续订NAT网关询价
    """

    def __init__(self, request_param):
        super(RenewPrivateNatPriceRequest, self).__init__("/v4/privatenat/query-renew-price", "POST", "ctnat", "application/json")
...
class RenewPrivateNatPriceRequestParam(object):
