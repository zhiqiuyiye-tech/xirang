...
class BindIAMUserToUserGroupRequest(CTYunRequest):
    """
    IAM认证-用户绑定用户组
    """

    def __init__(self, request_param):
        super(BindIAMUserToUserGroupRequest, self).__init__("/v1/user/iam/bind-to-user-groups", "POST", "iam", "application/json")
...
class BindIAMUserToUserGroupRequestParam(object):
