...
class UnbindVdcUserFromUserGroupRequest(CTYunRequest):
    """
    VDC用户组解绑用户
    """

    def __init__(self, request_param):
        super(UnbindVdcUserFromUserGroupRequest, self).__init__("/v1/vdc/unbind-users-from-user-group", "POST", "iam", "application/json")
...
class UnbindVdcUserFromUserGroupRequestParam(object):

    def __init__(self, group_id, user_ids=None):
        """
