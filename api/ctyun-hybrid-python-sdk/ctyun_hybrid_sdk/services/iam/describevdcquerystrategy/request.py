...
class DescribeVdcQueryStrategyRequest(CTYunRequest):
    """
    获取策略列表-VDC
    """

    def __init__(self, request_param):
        super(DescribeVdcQueryStrategyRequest, self).__init__("/v1/policy/vdc/queryStrategy", "POST", "iam", "application/json")
...
class DescribeVdcQueryStrategyRequestParam(object):
