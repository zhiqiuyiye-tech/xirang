...
class AddVdcUserGroupPermissionsRequest(CTYunRequest):
    """
    VDC用户组绑定策略
    """

    def __init__(self, request_param):
        super(AddVdcUserGroupPermissionsRequest, self).__init__("/v1/vdc/add-user-group-permissions", "POST", "iam", "application/json")
...
class AddVdcUserGroupPermissionsRequestParam(object):

    def __init__(self, range, group_id, strategy_ids, auth_region_id=None):
        """
