...
class OpenapiUpdateServiceRequest(CTYunRequest):
    """
    服务管理编辑
    """

    def __init__(self, request_param):
        super(OpenapiUpdateServiceRequest, self).__init__("/v1/service/updateService", "POST", "iam", "application/json")
...
class OpenapiUpdateServiceRequestParam(object):

    def __init__(self, id, name, cloud_type, type, code, data_version=None):
        """
        :param id: 主键
