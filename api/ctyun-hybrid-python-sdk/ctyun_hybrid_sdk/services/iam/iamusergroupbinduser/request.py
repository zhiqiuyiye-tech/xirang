...
class IamUserGroupBindUserRequest(CTYunRequest):
    """
    IAM认证-用户组绑定用户
    """

    def __init__(self, request_param):
        super(IamUserGroupBindUserRequest, self).__init__("/v1/userGroup/iam/bind-users", "POST", "iam", "application/json")
...
class IamUserGroupBindUserRequestParam(object):
