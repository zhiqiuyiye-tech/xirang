...
class BindVdcUserGroupToUserRequest(CTYunRequest):
    """
    VDC用户绑定用户组 
    """

    def __init__(self, request_param):
        super(BindVdcUserGroupToUserRequest, self).__init__("/v1/vdc/bind-user-groups-to-user", "POST", "iam", "application/json")
...
class BindVdcUserGroupToUserRequestParam(object):
