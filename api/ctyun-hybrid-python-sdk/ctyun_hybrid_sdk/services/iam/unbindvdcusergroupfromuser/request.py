...
class UnbindVdcUserGroupFromUserRequest(CTYunRequest):
    """
    VDC用户解绑用户组
    """

    def __init__(self, request_param):
        super(UnbindVdcUserGroupFromUserRequest, self).__init__("/v1/vdc/unbind-user-groups-from-user", "POST", "iam", "application/json")
...
class UnbindVdcUserGroupFromUserRequestParam(object):
