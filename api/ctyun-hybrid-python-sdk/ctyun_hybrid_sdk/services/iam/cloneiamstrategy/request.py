...
class CloneIamStrategyRequest(CTYunRequest):
    """
    克隆策略-IAM
    """

    def __init__(self, request_param):
        super(CloneIamStrategyRequest, self).__init__("/v1/policy/iam/cloneStrategy", "POST", "iam", "application/json")
...
class CloneIamStrategyRequestParam(object):
