...
class UnbindIAMUserGroupStrategiesRequest(CTYunRequest):
    """
    IAM认证-用户组解绑策略
    """

    def __init__(self, request_param):
        super(UnbindIAMUserGroupStrategiesRequest, self).__init__("/v1/userGroup/iam/unbind-strategies", "POST", "iam", "application/json")
...
class UnbindIAMUserGroupStrategiesRequestParam(object):
