...
class UpdateVdcStrategyRequest(CTYunRequest):
    """
    编辑自定义策略-VDC
    """

    def __init__(self, request_param):
        super(UpdateVdcStrategyRequest, self).__init__("/v1/policy/vdc/updateStrategy", "POST", "iam", "application/json")
...
class Statement(object):
    ...
    def __init__(self, resource, effect, action, ):
        """
        :param resource: 仅支持"*"，不论输入什么值，存入都是"*"
...
class UpdateVdcStrategyRequestParam(object):

    def __init__(self, strategy_content, strategy_name, range, strategy_id, description=None):
        """
