...
class DescribeIAMUserGroupStrategiesRequest(CTYunRequest):
    """
    IAM认证-用户组绑定策略查询
    """

    def __init__(self, request_param):
        super(DescribeIAMUserGroupStrategiesRequest, self).__init__("/v1/userGroup/iam/strategies", "GET", "iam", "")
