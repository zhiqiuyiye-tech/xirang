...
class GetQuotaStateRequest(CTYunRequest):
    """
    获取租户(VDC)的配额是否开启
    """

    def __init__(self, request_param):
        super(GetQuotaStateRequest, self).__init__("/v1/quota/state", "GET", "iam", "")
...
class GetQuotaStateRequestParam(object):

    def __init__(self, region_id, account_id=None, vdc_id=None):
        """
        :param account_id: 主账号ID，主账号、VDC必选填一个
        :param vdc_id: 主账号ID，主账号、VDC必选填一个
