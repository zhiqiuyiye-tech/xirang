...
class UpdateIamStrategyRequest(CTYunRequest):
    """
    编辑自定义策略-IAM
    """

    def __init__(self, request_param):
        super(UpdateIamStrategyRequest, self).__init__("/v1/policy/iam/updateStrategy", "POST", "iam", "application/json")
...
class UpdateIamStrategyRequestParam(object):
