...
class IamUserGroupUnBindUserRequest(CTYunRequest):
    """
    IAM认证-用户组解绑用户
    """

    def __init__(self, request_param):
        super(IamUserGroupUnBindUserRequest, self).__init__("/v1/userGroup/iam/unbind-users", "POST", "iam", "application/json")
...
class IamUserGroupUnBindUserRequestParam(object):
